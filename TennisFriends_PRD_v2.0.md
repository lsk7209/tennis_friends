...
MVP 완성 후 유틸리티와 콘텐츠로 유입을 확보하고, 네이버 카페 테니스프렌즈 참여로 연결합니다.

> 운영 결정(2026-08-27): 이 문서의 이전 AdSense·제휴 수익화 계획은 폐기되었습니다. 현재 1차 전환은 `https://cafe.naver.com/homecookie` 방문입니다.
