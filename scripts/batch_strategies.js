...
const strategies = [
  {
    ...
    meta: {
      ...
      alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-strategy-vs-lefty` },
      openGraph: { title: '왼손잡이 상대 공략법', description: '왼손잡이 특유의 스핀과 각도에 대응하는 전략. 서브 리턴부터 백핸드 대각선 공략까지 실전 팁.', url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-strategy-vs-lefty`, siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
  ...
  },
  {
    ...
    meta: {
      ...
      alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-windy-condition-tips` },
      openGraph: { title: '바람 부는 날 테니스 실전 가이드', description: '바람 많은 날에도 일관성을 유지하는 법. 토스 조정, 스핀 활용, 멘탈 관리까지.', url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-windy-condition-tips`, siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
  ...
  },
  {
    ...
    meta: {
      ...
      alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-drop-shot-mastery` },
      openGraph: { title: '드롭샷 마스터하기', description: '절묘한 타이밍과 터치로 승부를 가르는 드롭샷. 언제 사용할지, 어떻게 숨길지 완벽 가이드.', url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-drop-shot-mastery`, siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
  ...
  },
  {
    ...
    meta: {
      ...
      alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-lob-defense-offense` },
      openGraph: { title: '로브 활용법: 수비와 공격', description: '수비 로브와 공격 로브의 차이. 상황에 따른 로브 전술과 실전 연습법.', url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-lob-defense-offense`, siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
  ...
  },
  {
    ...
    meta: {
      ...
      alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-overhead-smash-guide` },
      openGraph: { title: '오버헤드 스매시 완벽 가이드', description: '확실한 포인트 마무리를 위한 스매시 기술. 풋워크, 타점, 임팩트까지 단계별 분석.', url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-overhead-smash-guide`, siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
  ...
  },
  {
    ...
    meta: {
      ...
      alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-slice-backhand-mastery` },
      openGraph: { title: '슬라이스 백핸드 활용법', description: '변화와 리듬 조절의 핵심 슬라이스. 언제 어떻게 사용할지, 실전 전술과 연습 드릴.', url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-slice-backhand-mastery`, siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
  ...
  },
  {
    ...
    meta: {
      ...
      alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-return-of-serve-strategy` },
      openGraph: { title: '서브 리턴 전략 완벽 가이드', description: '경기의 50%를 차지하는 리턴 게임. 위치 선택, 스플릿 스텝, 리턴 코스 전략까지.', url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-return-of-serve-strategy`, siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
  ...
  },
  {
    ...
    meta: {
      ...
      alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-net-play-positioning` },
      openGraph: { title: '네트 플레이 포지셔닝 가이드', description: '공격의 완성, 네트 플레이. 언제 올라갈지, 어디에 설지, 발리 각도까지 실전 팁.', url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-net-play-positioning`, siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
  ...
  },
  {
    ...
    meta: {
      ...
      alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-court-surfaces-explained` },
      openGraph: { title: '코트 표면별 전략: 하드, 클레이, 잔디', description: '하드, 클레이, 잔디 코트의 특성과 각 코트에서의 최적 전략. 슈즈 선택부터 전술까지.', url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tennisfrens.com'}/blog/tennis-court-surfaces-explained`, siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
