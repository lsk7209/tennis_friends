/**
 * 저CTR 선수 전용 정적 페이지 생성 스크립트
 * 실행: node scripts/generate-player-pages.js
 */
const fs = require("fs");
...
PLAYERS.forEach((slug) => {
  const dir = path.join("src/app/players", slug);
  fs.mkdirSync(dir, { recursive: true });
  const filepath = path.join(dir, "page.tsx");
  fs.writeFileSync(filepath, buildPage(slug), "utf8");
