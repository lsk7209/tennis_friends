...
export const metadata = ${JSON.stringify(d.meta, null, 2)};
...
const equipment = [
    {
        ...
        meta: {
            ...
            alternates: { canonical: 'https://tennisfriends.co.kr/blog/tennis-string-tension-guide' },
            openGraph: { title: '스트링 텐션 완벽 가이드', description: '높은 텐션 vs 낮은 텐션. 파워, 컨트롤, 스핀에 미치는 영향과 나에게 맞는 텐션 찾기.', url: 'https://tennisfriends.co.kr/blog/tennis-string-tension-guide', siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
    ...
    },
    {
        ...
        meta: {
            ...
            alternates: { canonical: 'https://tennisfriends.co.kr/blog/tennis-hybrid-string-setup' },
            openGraph: { title: '하이브리드 스트링 세팅 가이드', description: '메인과 크로스를 다르게. 폴리 + 멀티필라멘트 조합의 장점과 추천 세팅.', url: 'https://tennisfriends.co.kr/blog/tennis-hybrid-string-setup', siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
    ...
    },
    {
        ...
        meta: {
            ...
            alternates: { canonical: 'https://tennisfriends.co.kr/blog/tennis-grip-size-selection' },
            openGraph: { title: '그립 사이즈 선택 가이드', description: '너무 크거나 작으면 부상 위험. 정확한 그립 사이즈 측정법과 선택 기준.', url: 'https://tennisfriends.co.kr/blog/tennis-grip-size-selection', siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
    ...
    },
    {
        ...
        meta: {
            ...
            alternates: { canonical: 'https://tennisfriends.co.kr/blog/tennis-overgrip-guide' },
            openGraph: { title: '오버그립 완벽 가이드', description: '땀 흡수와 그립감 개선의 필수 아이템. 종류별 특징과 교체 주기, 감는 방법까지.', url: 'https://tennisfriends.co.kr/blog/tennis-overgrip-guide', siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
    ...
    },
    {
        ...
        meta: {
            ...
            alternates: { canonical: 'https://tennisfriends.co.kr/blog/tennis-dampener-effectiveness' },
            openGraph: { title: '진동 흡수기(댐퍼)의 효과와 선택', description: '정말 효과가 있나? 과학적 분석과 선수들의 사용 이유, 추천 제품까지.', url: 'https://tennisfriends.co.kr/blog/tennis-dampener-effectiveness', siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
    ...
    },
    {
        ...
        meta: {
            ...
            alternates: { canonical: 'https://tennisfriends.co.kr/blog/tennis-mental-closing-matches' },
            openGraph: { title: '경기 마무리 멘탈 관리법', description: '5-3에서 패배하는 이유. 리드를 지키고 경기를 확실히 마무리하는 멘탈 전략.', url: 'https://tennisfriends.co.kr/blog/tennis-mental-closing-matches', siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
    ...
    },
    {
        ...
        meta: {
            ...
            alternates: { canonical: 'https://tennisfriends.co.kr/blog/tennis-wrist-knee-pain-care' },
            openGraph: { title: '손목·무릎 통증 예방과 관리', description: '테니스 엘보부터 점퍼스 니까지. 흔한 부상 예방법과 통증 발생 시 대처법.', url: 'https://tennisfriends.co.kr/blog/tennis-wrist-knee-pain-care', siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
    ...
    },
    {
        ...
        meta: {
            ...
            alternates: { canonical: 'https://tennisfriends.co.kr/blog/tennis-nutrition-pre-match' },
            openGraph: { title: '경기 전 영양 섭취 가이드', description: '경기 2시간 전 무엇을 먹어야 하나? 에너지와 컨디션을 최적화하는 식단 전략.', url: 'https://tennisfriends.co.kr/blog/tennis-nutrition-pre-match', siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
    ...
    },
    {
        ...
        meta: {
            ...
            alternates: { canonical: 'https://tennisfriends.co.kr/blog/history-of-tennis-scoring' },
            openGraph: { title: '테니스 점수 체계의 역사: 왜 15-30-40인가?', description: '15, 30, 40의 비밀과 듀스, 애드밴티지의 유래. 테니스 스코어링의 흥미로운 역사.', url: 'https://tennisfriends.co.kr/blog/history-of-tennis-scoring', siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
    ...
    },
    {
        ...
        meta: {
            ...
            alternates: { canonical: 'https://tennisfriends.co.kr/blog/tennis-bag-essentials-checklist' },
            openGraph: { title: '테니스 가방 필수품 체크리스트', description: '라켓만 챙기면 끝? 잊지 말아야 할 필수 아이템과 추천 준비물까지.', url: 'https://tennisfriends.co.kr/blog/tennis-bag-essentials-checklist', siteName: 'TennisFriends', locale: 'ko_KR', type: 'article' },
