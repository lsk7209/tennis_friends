...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://www.tennisfrens.com/players/adrian-mannarino',
    },
    openGraph: {
        title: '아드리안 만나리노 — 코트 위의 마법사 | 플레이스타일·명장면·최근 경기력',
        description: '아드리안 만나리노의 독특한 스윙과 낮은 텐션, 강점, 대표 경기, 최근 흐름을 한 번에 정리한 선수 프로필.',
        url: 'https://www.tennisfrens.com/players/adrian-mannarino',
            ...
            >
                ...
                <BreadcrumbSchema
                    items={[
                        ...
                        { name: '아드리안 만나리노', item: 'https://www.tennisfrens.com/players/adrian-mannarino' },
                    ]}
                />
                <FAQSchema faqs={faqs} />
