...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://www.tennisfrens.com/players/matteo-berrettini',
    },
    openGraph: {
        title: '마테오 베레티니 — 이탈리아의 망치 | 플레이스타일·명장면·최근 경기력',
        description: '마테오 베레티니의 강력한 서브와 포핸드, 강점, 대표 경기, 최근 흐름을 한 번에 정리한 선수 프로필.',
        url: 'https://www.tennisfrens.com/players/matteo-berrettini',
            ...
            >
                ...
                <BreadcrumbSchema
                    items={[
                        ...
                        { name: '마테오 베레티니', item: 'https://www.tennisfrens.com/players/matteo-berrettini' },
                    ]}
                />
                <FAQSchema faqs={faqs} />
