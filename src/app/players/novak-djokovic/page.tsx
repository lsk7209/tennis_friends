          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <div className="not-prose my-6 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-800">
              <ul className="space-y-2 text-sm">
                <li><strong>국적:</strong> 세르비아</li>
                <li><strong>생년:</strong> 1987년 (30대 후반)</li>
                <li><strong>최고 랭킹:</strong> 1위</li>
                <li><strong>현재 랭킹:</strong> 1위</li>
                <li><strong>1위 유지 기간:</strong> 400주 이상</li>
                <li><strong>주 종목:</strong> 단식 (ATP 투어)</li>
                <li><strong>플레이 스타일:</strong> 전천후 플레이어</li>
                <li><strong>그랜드 슬램:</strong> 24회 우승 (남자 테니스 최다 기록)</li>
              </ul>
            </div>
            ...
            <div className="not-prose my-4 p-3 bg-green-50 dark:bg-green-950/20 border-l-3 border-green-500 rounded-r">
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-0">
                타이브레이크 승률 <strong className="text-green-700 dark:text-green-400">70% 이상</strong> · 5세트 경기 후반 안정성 · 절차적 완성도
              </p>
            </div>
            ...
            <h3>피지컬 능력</h3>
            <p>코트 커버리지와 체력 관리가 뛰어나다. 전진과 후퇴를 자유롭게 오간다. 장기전에서도 에너지 관리를 효율적으로 한다. 5세트 경기에서도 후반까지 안정적인 경기력을 유지한다. 나이가 들어감에 따라 경기 선택을 더욱 정밀하게 하면서도 큰 대회에서 최고의 컨디션을 발휘한다.</p>
            ...
            <div className="not-prose my-4 p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-800">
              <p className="text-sm font-semibold text-blue-900 dark:text-blue-100 mb-2">🏆 멘탈 강점의 결정적 증명</p>
