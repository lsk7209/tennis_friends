...
export const metadata: Metadata = {
    title: '아르튀르 필스 프로필 | 랭킹·전적',
    description: "아르튀르 필스(Arthur Fils)의 ATP 랭킹, 파워 테니스, 주요 전적, 최근 경기 흐름과 강점·약점을 한눈에 정리했습니다.",
    keywords: ['아르튀르 필스', 'Arthur Fils', '테니스', 'ATP', '플레이스타일', '프랑스 유망주', '넥스트젠', '파워 테니스'],
    alternates: {
        canonical: 'https://www.tennisfrens.com/players/arthur-fils',
    },
    openGraph: {
        title: '아르튀르 필스 프로필 | 랭킹·전적',
        description: '아르튀르 필스의 ATP 랭킹, 파워 테니스, 주요 전적, 최근 경기 흐름과 강점·약점을 한눈에 정리했습니다.',
        url: 'https://www.tennisfrens.com/players/arthur-fils',
            ...
            >
                ...
                <BreadcrumbSchema
                    items={[
                        ...
                        { name: '아르튀르 필스', item: 'https://www.tennisfrens.com/players/arthur-fils' },
                    ]}
                />
                <FAQSchema faqs={faqs} />
