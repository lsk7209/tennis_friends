...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://tennisfrens.com/players/gael-monfils',
    },
    openGraph: {
        title: '가엘 몽필스 — 코트 위의 슈퍼히어로 | 플레이스타일·명장면·최근 경기력',
        description: '가엘 몽필스의 놀라운 운동신경과 쇼맨십, 강점, 대표 경기, 최근 흐름을 한 번에 정리한 선수 프로필.',
        url: 'https://tennisfrens.com/players/gael-monfils',
            ...
            >
                ...
                <BreadcrumbSchema
                    items={[
                        ...
                        { name: '가엘 몽필스', item: 'https://tennisfrens.com/players/gael-monfils' },
                    ]}
                />
                <FAQSchema faqs={faqs} />
