...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://tennisfrens.com/players/matteo-arnaldi',
    },
    openGraph: {
        title: '마테오 아르날디 — 이탈리아의 새로운 엔진 | 플레이스타일·명장면·최근 경기력',
        description: '마테오 아르날디의 지칠 줄 모르는 체력과 끈기, 강점, 대표 경기, 최근 흐름을 한 번에 정리한 선수 프로필.',
        url: 'https://tennisfrens.com/players/matteo-arnaldi',
            ...
            >
                ...
                <BreadcrumbSchema
                    items={[
                        ...
                        { name: '마테오 아르날디', item: 'https://tennisfrens.com/players/matteo-arnaldi' },
                    ]}
                />
                <FAQSchema faqs={faqs} />
