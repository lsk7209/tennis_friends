...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://tennisfrens.com/players/jiri-lehecka',
  },
  openGraph: {
    title: '이르지 레헤치카 완전 분석 | 플레이 스타일·명경기·ATP 프로필',
    description: '이르지 레헤치카의 공격형 스타일, 강점, 대표 경기, 최근 흐름을 한 번에 정리한 선수 프로필.',
    url: 'https://tennisfrens.com/players/jiri-lehecka',
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-blue-950 dark:via-gray-900 dark:to-purple-950">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: '이리 레헤츠카', item: 'https://tennisfrens.com/players/jiri-lehecka' },
        ]}
      />
