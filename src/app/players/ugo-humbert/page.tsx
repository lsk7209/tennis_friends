...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://tennisfrens.com/players/ugo-humbert',
  },
  openGraph: {
    title: '우고 움베르 — 세계랭킹 상위권 | 플레이스타일·명장면·최근 경기력',
    description: '우고 움베르의 공격적인 좌완 스타일, 강점, 대표 경기, 최근 흐름을 한 번에 정리한 선수 프로필.',
    url: 'https://tennisfrens.com/players/ugo-humbert',
      ...
      ><ProfilePageSchema
        ...
        <BreadcrumbSchema
          items={[
            ...
            { name: '우고 움베르', item: 'https://tennisfrens.com/players/ugo-humbert' },
          ]}
        />
        <FAQSchema faqs={faqs} />
