...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://www.tennisfrens.com/players/jaume-munar',
    },
    openGraph: {
        title: '자우메 무나르 — 클레이 코트 스페셜리스트 | 플레이스타일·명장면·최근 경기력',
        description: '자우메 무나르의 클레이 코트 전문가 스타일, 강점, 대표 경기, 최근 흐름을 한 번에 정리한 선수 프로필.',
        url: 'https://www.tennisfrens.com/players/jaume-munar',
    ...
    return (
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: '자우메 무나르', item: 'https://www.tennisfrens.com/players/jaume-munar' },
        ]}
      />
      <FAQSchema faqs={faqs} />
