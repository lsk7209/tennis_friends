...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://www.tennisfrens.com/players/jan-lennard-struff',
    },
    openGraph: {
        title: '얀-레나드 스트루프 — 독일의 썬더볼트 | 플레이스타일·명장면·최근 경기력',
        description: '얀-레나드 스트루프의 강력한 서브와 네트 플레이, 강점, 대표 경기, 최근 흐름을 한 번에 정리한 선수 프로필.',
        url: 'https://www.tennisfrens.com/players/jan-lennard-struff',
            ...
            >
                ...
                <BreadcrumbSchema
                    items={[
                        ...
                        { name: '얀-레나드 스트루프', item: 'https://www.tennisfrens.com/players/jan-lennard-struff' },
                    ]}
                />
                <FAQSchema faqs={faqs} />
