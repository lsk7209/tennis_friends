        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <div className="not-prose my-4 p-3 bg-amber-50 dark:bg-amber-950/20 border-l-3 border-amber-500 rounded-r">
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-0">
                <strong>2018-2020년:</strong> 랭킹 <strong className="text-amber-700 dark:text-amber-400">3위 → 70위대</strong> 하락
              </p>
            </div>
            <p><strong>2018년부터 2020년</strong> 사이가 가장 어려운 시기였다. 어깨 부상으로 인해 서브와 포핸드에 제약이 생겼다. 손목 문제는 백핸드의 정확도를 떨어뜨렸다. 랭킹은 <strong>3위에서 70위대까지</strong> 떨어졌다. 큰 대회에서 조기 탈락이 반복되었다. 이 시기 동안 그는 자신의 테니스에 대한 의문과 회의를 경험했다고 인터뷰에서 밝힌 바 있다.</p>
            ...
            <p>2017년 ATP 파이널에서 그는 우승을 차지하며 전성기를 구가했다. 당시 세계 최고 수준의 선수들을 연파하며 우승했다. 특히 결승전에서의 경기력은 그의 기술적 완성도를 보여주는 대표적인 사례였다.</p>
