...
export const metadata: Metadata = {
  ...
  description: '데니스 샤포발로프의 공격형 스타일, 강점, 대표 경기, 최근 흐름을 한 번에 정리한 선수 프로필. 강력한 포핸드와 좌완 서브로 ATP 투어를 지배하는 캐나다의 차세대 스타.',
...
const tocItems: Array<{ id: string; text: string; depth: 2 | 3 }> = [
  { id: 'why-again-notable', text: '데니스 샤포발로프, 왜 주목받는 선수인가?', depth: 2 },
  { id: 'what-type-of-player', text: '이 선수는 어떤 유형의 플레이어인가?', depth: 2 },
  { id: 'what-keeps-top-ranking', text: '이 선수가 세계 상위권을 지키는 힘은 무엇인가?', depth: 2 },
  { id: 'what-proves-player', text: '이 선수를 가장 잘 보여주는 경기는 무엇일까?', depth: 2 },
  { id: 'what-attracts-fans', text: '팬들은 이 선수의 어떤 점에 끌릴까?', depth: 2 },
  { id: 'recent-form', text: '요즘 데니스 샤포발로프의 경기력 흐름은 어떤가?', depth: 2 },
  { id: 'one-sentence-summary', text: '데니스 샤포발로프, 한 문장으로 정리하면?', depth: 2 },
];

const faqs = [
  {
    q: '데니스 샤포발로프의 경기 스타일은 어떤가요?',
    a: '공격형 스타일로, 강력한 포핸드와 좌완 서브가 특징입니다. 빠른 발과 넓은 리치로 코트를 압박합니다.',
  },
  {
    q: '샤포발로프의 최고 랭킹과 현재 랭킹은 어떻게 되나요?',
    a: '최고 랭킹은 10위였으며, 현재는 23위권을 유지하고 있습니다. 특히 좌완 서브로 유명합니다.',
  },
];

export default function DenisShapovalovPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-blue-950 dark:via-gray-900 dark:to-purple-950">
      <Article
        title="데니스 샤포발로프"
        excerpt="강력한 포핸드와 좌완 서브로 ATP 투어를 지배하는 캐나다의 차세대 스타"
      >
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
          <div className="flex flex-wrap gap-2 mb-6">
            {['테니스', '데니스 샤포발로프', '선수 프로필', '캐나다', '공격형', '좌완 서브'].map((tag) => (
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h2 id="why-again-notable">데니스 샤포발로프, 왜 주목받는 선수인가?</h2>
            <blockquote className="not-prose my-6 p-4 bg-blue-50 dark:bg-blue-950/30 border-l-4 border-blue-500 rounded-r-lg">
              <div className="flex items-start gap-3">
                <Star className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
                <p className="text-base font-medium text-gray-800 dark:text-gray-200 mb-0">
                  강력한 포핸드와 좌완 서브로 ATP 투어를 지배하는 캐나다의 차세대 스타
                </p>
              </div>
            </blockquote>
            <p>데니스 샤포발로프는 캐나다 출신의 세계랭킹 23위권 테니스 선수로, 강력한 포핸드와 좌완 서브로 ATP 투어를 지배하고 있다. 세계랭킹 23위권을 유지하며, 특히 좌완 서브로 유명하다. 빠른 발과 넓은 리치로 코트를 압박하는 그의 테니스는 차세대 스타의 설계자로 평가받는다.</p>

            <h2 id="what-type-of-player">이 선수는 어떤 유형의 플레이어인가?</h2>
            <p>데니스 샤포발로프는 캐나다 출신의 세계랭킹 23위권 선수로, 공격형 스타일과 강력한 포핸드, 좌완 서브가 특징인 ATP 투어의 차세대 스타다.</p>
            ...
            <div className="not-prose my-6 p-5 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/50 dark:to-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm">
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-gray-700 dark:text-gray-300">최고 랭킹:</strong> <span className="text-gray-600 dark:text-gray-400">10위</span></span>
                </li>
                <li className="flex items-start gap-3">
                  <TrendingUp className="w-4 h-4 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
                  <span><strong className="text-gray-700 dark:text-gray-300">현재 랭킹:</strong> <span className="text-gray-600 dark:text-gray-400">23위권</span></span>
                </li>
                <li className="flex items-start gap-3">
            ...
            <p>샤포발로프는 경기력뿐 아니라 창의적이고 재미있는 플레이 덕분에 팬층이 두텁다.</p>

            <h2 id="recent-form">요즘 데니스 샤포발로프의 경기력 흐름은 어떤가?</h2>
            <p>최근 몇 시즌 동안 샤포발로프는 안정적인 경기력을 보여주고 있으며, 큰 대회에서도 좋은 성적을 거두고 있다.</p>

            <h2 id="one-sentence-summary">데니스 샤포발로프, 한 문장으로 정리하면?</h2>
            <p>데니스 샤포발로프는 강력한 포핸드와 좌완 서브로 ATP 투어를 지배하는 캐나다의 차세대 스타다.</p>
          </div>
