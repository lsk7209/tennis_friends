...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://tennisfrens.com/players/zhizhen-zhang',
    },
    openGraph: {
        title: '장지전 — 대륙의 자존심 | 플레이스타일·명장면·최근 경기력',
        description: '장지전의 강력한 포핸드와 서브, 강점, 대표 경기, 최근 흐름을 한 번에 정리한 선수 프로필.',
        url: 'https://tennisfrens.com/players/zhizhen-zhang',
            ...
            >
                ...
                <BreadcrumbSchema
                    items={[
                        ...
                        { name: '장지전', item: 'https://tennisfrens.com/players/zhizhen-zhang' },
                    ]}
                />
                <FAQSchema faqs={faqs} />
