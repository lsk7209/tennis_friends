...
const tocItems: Array<{ id: string; text: string; depth: 2 | 3 }> = [
  {
    id: "autumn-ball-reaction",
    text: "가을에는 \'공의 반응\'부터 다르다",
    depth: 2,
  },
  {
    id: "rhythm-footwork",
    text: "리듬을 만드는 건 스윙이 아니라 풋워크다",
    depth: 2,
  },
  {
    id: "tempo-strategy",
    text: "템포 조절이 전략이다 — 리듬을 깨는 플레이",
    depth: 2,
  },
  {
    id: "regional-court-strategy",
    text: "지역별 코트 전략 — 서울·부산·제주의 리듬은 다르다",
    depth: 2,
  },
  {
    id: "autumn-equipment-setup",
    text: "가을 라켓 세팅과 장비 조정",
    depth: 2,
  },
  { id: "daily-rhythm-recovery", text: "하루 30분 리듬 회복 루틴", depth: 2 },
  {
    id: "rhythm-body-mind",
    text: "리듬이란 몸과 마음이 같은 박자를 타는 순간",
    depth: 2,
  },
    ...
    >
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950 dark:to-orange-950 p-6 rounded-lg mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          요즘 서브 타이밍이 자꾸 늦고, 공이 무겁게 느껴지지 않나요? 가을에는
          누구나 이런 감각 저하를 겪습니다. 여름의 빠른 템포에 익숙해진 몸이
          온도와 공기의 변화에 적응하지 못하기 때문이죠. 하지만 바로 이 시기가
          '리듬'을 다시 세팅할 최고의 기회입니다.
        </p>
      </div>
      ...
      <div className="bg-white/50 p-4 rounded-lg mb-4">
        ...
        <ul className="space-y-1 text-sm">
          <li>
            •{" "}
            <a
              href="https://www.tennis.com/pro-game/2021/01/tennis-footwork-guide/789456/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-600 hover:underline"
            >
              테니스 풋워크 가이드 - Tennis.com
            </a>
          </li>
          <li>
            •{" "}
            <a
              href="https://www.usta.com/en/home/improve/technique/footwork-fundamentals.html"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-600 hover:underline"
            >
      ...
      <section id="autumn-ball-reaction" className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
          <span className="bg-amber-500 text-white rounded-lg w-8 h-8 flex items-center justify-center text-sm font-bold">
            1
          </span>
          가을에는 '공의 반응'부터 다르다
        </h2>
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          가을 공기는 밀도가 높아 공이 무겁고 반발력이 줄어듭니다. 낮엔 가볍게
          튀다가 밤이 되면 공이 느려지죠. 이럴 때는 스윙을 세게 하기보다{" "}
          <strong>리듬을 일정하게 유지하는 것</strong>이 중요합니다. 팔로스루를
          끝까지 가져가고, 스윙 템포를 '빠르게-느리게'가 아닌{" "}
          <strong>'일정하게'</strong> 유지해야 합니다. 서브 타이밍은 한 박자
          빨리, 임팩트는 가볍게. 이 미묘한 차이가 경기 흐름을 바꿉니다.
        </p>

        <div className="bg-amber-50 dark:bg-amber-950 p-4 rounded-lg border-l-4 border-amber-500">
          <p className="text-amber-800 dark:text-amber-200 text-sm">
            <strong>👉 실전 팁:</strong> 저녁 경기에서는 스트링 텐션을 1~2파운드
            낮추면 반발력을 회복할 수 있습니다.
          </p>
        </div>
      </section>
      ...
      <section id="rhythm-footwork" className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
          <span className="bg-green-500 text-white rounded-lg w-8 h-8 flex items-center justify-center text-sm font-bold">
            2
          </span>
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          풋워크는 리듬의 시작입니다. 가을 코트에는 낙엽이 쌓이거나 미끄러운
          구간이 많아 발의 중심이 흔들리기 쉽습니다. 이럴수록 발 앞쪽(볼)에 무게
          중심을 두고, <strong>스플릿 스텝(split step)</strong>으로 반박자 먼저
          반응하는 것이 핵심입니다.
        </p>
        ...
        <ul className="space-y-3 mb-6">
          ...
          <li className="flex items-start gap-3">
            <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
            <span className="text-gray-700 dark:text-gray-300">
              라켓 없이 풋워크만으로 포지셔닝 훈련
            </span>
          </li>
          <li className="flex items-start gap-3">
            <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
            <span className="text-gray-700 dark:text-gray-300">
              코치보다 <strong>"박자감"</strong>을 의식하며 스텝 밟기
            </span>
          </li>
        </ul>
        ...
        <div className="bg-green-50 dark:bg-green-950 p-4 rounded-lg border-l-4 border-green-500">
          <p className="text-green-800 dark:text-green-200 text-sm">
            <strong>👉 실천:</strong> 미니 테니스 10분만으로도 몸의 타이밍이
            달라집니다.
          </p>
        </div>
      </section>
      ...
      <section id="tempo-strategy" className="mb-12">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          가을은 대회 시즌이 많고, 경기 템포가 빨라집니다. 상대의 흐름을
          무너뜨리는 건 '힘'이 아니라 '리듬의 변주'입니다. 공의 속도, 스핀,
          높이를 한 랠리 안에서도 변화시켜보세요. 예를 들어, 상대가 베이스라인에
          익숙하다면 의도적으로 슬라이스로 템포를 낮추거나 로브로 리듬을 끊을 수
          있습니다.
        </p>

        <blockquote className="border-l-4 border-blue-500 pl-6 py-4 bg-blue-50 dark:bg-blue-950 italic">
          <p className="text-blue-800 dark:text-blue-200">
            "한 포인트를 이기는 게 아니라, 상대의 리듬을 무너뜨리는 것." — 모든
            시합의 기본 원칙입니다.
          </p>
        </blockquote>
      </section>
      ...
      <section id="regional-court-strategy" className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
          <span className="bg-purple-500 text-white rounded-lg w-8 h-8 flex items-center justify-center text-sm font-bold">
            4
          </span>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-sm">
              습도가 높고 공이 무겁게 느려짐. 랠리 중심의 인내형 플레이 유리.
            </p>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-sm">
              바람이 강해 타점이 흔들림. 스윙을 짧게 끊는 연습 필요.
            </p>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-sm">
              해풍 영향으로 공의 궤적이 흔들림. 스핀 볼 제어 연습 필수.
            </p>
          </div>
        </div>
        ...
        <div className="bg-purple-50 dark:bg-purple-950 p-4 rounded-lg border-l-4 border-purple-500">
          <p className="text-purple-800 dark:text-purple-200 text-sm">
            <strong>👉 GEO 팁:</strong> 지역 검색 강화 시대, '서울 가을 테니스
            코트', '부산 테니스장 랠리 팁' 같은 키워드로 검색 유입을 확보하세요.
          </p>
        </div>
      </section>
      ...
      <section id="autumn-equipment-setup" className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
          <span className="bg-orange-500 text-white rounded-lg w-8 h-8 flex items-center justify-center text-sm font-bold">
            5
          </span>
          가을 라켓 세팅과 장비 조정
        </h2>
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          가을은 라켓 세팅을 다시 점검할 때입니다. 여름에 늘어난 스트링은
          반발력이 줄어듭니다. 폴리 스트링을 사용 중이라면 하이브리드로
          교체하고, 텐션은 1~2파운드 낮추세요.
        </p>

        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          또한 <strong>테니스화의 접지력</strong>은 부상 방지의 핵심입니다.
          낙엽이 많은 코트에서는 작은 미끄러짐이 발목 부상으로 이어질 수 있으니,
          새 신발은 꼭 '멀티코트용'으로 교체하는 것이 좋습니다.
        </p>
      </section>

      <section id="daily-rhythm-recovery" className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
          <span className="bg-red-500 text-white rounded-lg w-8 h-8 flex items-center justify-center text-sm font-bold">
            6
          </span>
          하루 30분 리듬 회복 루틴
        </h2>
        ...
        <p className="text-gray-700 dark:text-gray-300 mt-6 leading-relaxed">
          이 루틴만으로도 몸이 리듬을 기억합니다. 3일만 이어가도 "공이 다시
          가벼워졌다"는 느낌을 받을 겁니다.
        </p>
      </section>
      ...
      <section id="rhythm-body-mind" className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
          <span className="bg-indigo-500 text-white rounded-lg w-8 h-8 flex items-center justify-center text-sm font-bold">
            7
          </span>
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          테니스는 결국 박자의 경기입니다. 코치에게 기술을 배울 수는 있지만,{" "}
          <strong>리듬은 스스로 만들어야 합니다.</strong> 가을 바람이 불 때,
          몸이 자연스럽게 음악을 타듯 스윙하는 그 순간—그게 바로 당신의 테니스가
          성장하는 순간입니다.
        </p>
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          지금 리듬을 되찾았다면,{" "}
          <Link
            href="/blog/winter-indoor-tennis-guide"
      ...
      <section id="autumn-tennis-checklist" className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
          <span className="bg-teal-500 text-white rounded-lg w-8 h-8 flex items-center justify-center text-sm font-bold">
            8
          </span>
          가을 테니스 체크리스트
        </h2>
        ...
        <div className="bg-teal-50 dark:bg-teal-950 p-6 rounded-lg">
          <h3 className="font-bold text-teal-800 dark:text-teal-200 mb-4">
            👉 가을 테니스 체크리스트
          </h3>
            ...
            <Card className="bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 hover:border-blue-400 transition-all group cursor-pointer">
              <CardContent className="p-4">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm line-clamp-2">
                  테니스에서 50%의 승패를 좌우하는 풋워크 기술. 스플릿 스텝,
                  크로스오버, 사이드 셔플의 올바른 방법과 연습법.
                </p>
              </CardContent>
            </Card>
          </Link>
