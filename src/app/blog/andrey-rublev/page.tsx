...
export default function AndreyRublevBlogPost() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-blue-950 dark:via-gray-900 dark:to-purple-950">
      <Article
        title="안드레이 루블레프 — 불꽃 같은 포핸드로 흐름을 찢는 힘"
        excerpt="폭발적인 포핸드와 흐름을 밀어붙이는 템포, 간결한 루틴으로 승부를 조립하는 안드레이 루블레프의 성장, 스타일, 인간적인 면모와 과제를 한 편으로."
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h1 id="andrey-rublev-flame-forehand-tear-flow-power">안드레이 루블레프 — 불꽃 같은 포핸드로 흐름을 찢는 힘</h1>

            <p><strong>직답:</strong> 안드레이 루블레프(Andrey Rublev)는 폭발적인 포핸드와 높은 템포, 간결한 루틴으로 랠리의 공기를 바꾸며 승부를 밀어붙이는 러시아의 간판입니다.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <ul className="space-y-1 text-sm">
                  ...
                  <li><a href="https://en.wikipedia.org/wiki/Andrey_Rublev" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-200">위키피디아 프로필</a></li>
                </ul>
              </div>
            </div>
          </div>
