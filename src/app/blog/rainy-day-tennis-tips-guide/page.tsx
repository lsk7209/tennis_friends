...
const tocItems: Array<{ id: string; text: string; depth: 2 | 3 }> = [
  {
    id: "indoor-alternative-routine",
    text: "실내 대체 루틴으로 리듬 유지",
    depth: 2,
  },
  {
    id: "wall-training-contact-point",
    text: "벽치기·리턴 훈련으로 타점 감각 유지",
    depth: 2,
  },
  {
    id: "equipment-management",
    text: "장비 관리 — 비에 젖은 라켓은 즉시 말린다",
    depth: 2,
  },
  {
    id: "condition-recovery-routine",
    text: "컨디션 회복 루틴 — 몸은 쉬어도 감각은 유지",
    depth: 2,
  },
  {
    id: "regional-weather-response",
    text: "지역별 날씨 대응 전략 — 서울·부산·광주·제주",
    depth: 2,
  },
  {
    id: "sensory-recovery-routine",
    text: "감각 회복 루틴 — 20분 집중 플로우",
    depth: 2,
  },
    ...
    >
      <div className="bg-gradient-to-r from-slate-50 to-gray-50 dark:from-slate-950 dark:to-gray-950 p-6 rounded-lg mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          비 오는 날이면 대부분의 아마추어들은 훈련을 멈춘다. 그러나 고수들은
          오히려 이 시간을 '감각 유지 훈련'에 쓴다. 공을 치지 않아도, 감각은
          유지할 수 있다. 비가 와도 테니스는 멈추지 않는다.
        </p>
      </div>
      ...
      <section id="indoor-alternative-routine" className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
          <span className="bg-slate-500 text-white rounded-lg w-8 h-8 flex items-center justify-center text-sm font-bold">
            1
          </span>
          실내 대체 루틴으로 리듬 유지
        </h2>
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          비 오는 날 가장 먼저 해야 할 일은 '루틴을 끊지 않는 것'이다. 실내에서
          할 수 있는 루틴을 미리 정해두면, 감각 저하 없이 다음 훈련으로
          이어진다.
        </p>
        ...
        <div className="bg-slate-50 dark:bg-slate-950 p-4 rounded-lg border-l-4 border-slate-500">
          <p className="text-slate-800 dark:text-slate-200 text-sm">
            <strong>👉 핵심:</strong> 리듬을 잃지 않는 것이 곧 감각을 유지하는
            길이다.
          </p>
        </div>
      </section>
      ...
      <section id="wall-training-contact-point" className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
          <span className="bg-gray-500 text-white rounded-lg w-8 h-8 flex items-center justify-center text-sm font-bold">
            2
          </span>
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          실내나 주차장 벽면에서도 벽치기 훈련은 충분히 가능하다. 벽과의 거리
          3~4m를 유지하고 짧은 타이밍으로 리턴하라. 공이 빠르게 반사될수록
          반응속도와 타점 감각이 되살아난다.
        </p>
        ...
        <div className="bg-gray-50 dark:bg-gray-950 p-4 rounded-lg border-l-4 border-gray-500">
          <p className="text-gray-800 dark:text-gray-200 text-sm">
            <strong>👉 훈련 팁:</strong> 라켓이 아니라 손바닥으로 공을 톡톡 치는
            '핸드컨트롤' 연습도 타점 회복에 도움이 된다.
          </p>
        </div>
      </section>
      ...
      <section id="equipment-management" className="mb-12">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          비에 젖은 라켓을 그대로 두면 텐션이 빠르게 줄어든다. 스트링은 습기에
          약하므로 반드시 즉시 닦고 건조해야 한다.
        </p>
        ...
        <div className="bg-blue-50 dark:bg-blue-950 p-4 rounded-lg border-l-4 border-blue-500 mt-4">
          <p className="text-blue-800 dark:text-blue-200 text-sm">
            <strong>👉 주의:</strong> 드라이기로 말리면 스트링이 수축되어 텐션이
            불안정해진다.
          </p>
        </div>
      </section>
      ...
      <section id="condition-recovery-routine" className="mb-12">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          비 오는 날은 몸을 쉬게 하되, '감각적 연결'을 끊지 않아야 한다. 눈으로
          경기 영상을 보고, 귀로 리듬을 듣고, 몸으로 흐름을 기억하는 것이다.
        </p>
      ...
      <section id="regional-weather-response" className="mb-12">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          한국의 코트 환경은 지역별로 다르다. 날씨 대응 전략도 그에 맞춰
          조정해야 한다.
        </p>
        ...
        <div className="bg-indigo-50 dark:bg-indigo-950 p-4 rounded-lg border-l-4 border-indigo-500">
          <p className="text-indigo-800 dark:text-indigo-200 text-sm">
            <strong>👉 GEO 팁:</strong> "서울 비 오는 날 테니스", "부산 실내
            테니스장" 같은 키워드는 로컬 유입에 강하다.
          </p>
        </div>
      </section>
      ...
      <section id="sensory-recovery-routine" className="mb-12">
        ...
        <div className="bg-pink-50 dark:bg-pink-950 p-4 rounded-lg border-l-4 border-pink-500">
          <p className="text-pink-800 dark:text-pink-200 text-sm">
            <strong>👉 핵심:</strong> 훈련의 목적은 '완성'이 아니라 '유지'다.
            감각은 단 하루만 쉬어도 희미해진다.
          </p>
        </div>
      </section>
      ...
      <section id="rain-reset-signal" className="mb-12">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          비 오는 날은 리듬을 리셋하는 좋은 기회다. 빠른 스윙, 무리한 스텝보다
          '균형'과 '감각'을 다시 세팅하라. 멈춘다고 잃는 게 아니다. 멈춤 속에서
          새로운 리듬이 만들어진다.
        </p>
            ...
            <Card className="bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 hover:border-blue-400 transition-all group cursor-pointer">
              <CardContent className="p-4">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm line-clamp-2">
                  겨울 테니스 실내 코트에서 스윙 감각과 스피드를 유지하는 7가지
                  루틴. 장비, 워밍업, 리듬 훈련, 컨디션 관리까지 완벽 가이드.
                </p>
              </CardContent>
            </Card>
          </Link>
          <Link href="/blog/tennis-string-guide">
            <Card className="bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 hover:border-blue-400 transition-all group cursor-pointer">
              <CardContent className="p-4">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm line-clamp-2">
                  스트링 텐션별 특징, 재질별 반발력 차이, 계절별 세팅법까지 완전
                  정리. 당신의 손에 맞는 라켓 세팅 가이드.
                </p>
              </CardContent>
            </Card>
          </Link>
