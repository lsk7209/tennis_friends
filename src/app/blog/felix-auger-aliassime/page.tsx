...
const faqs = [
  {
    q: "펠릭스 오제-알리아심: 캐나다의 테니스 희망 관련 자주 묻는 질문 1",
    a: '이곳에 답변이 들어갑니다. 구체적이고 도움이 되는 정보를 제공하세요.'
  },
  {
    q: "펠릭스 오제-알리아심: 캐나다의 테니스 희망 관련 자주 묻는 질문 2",
      ...
      <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 dark:from-blue-900 dark:via-purple-900 dark:to-indigo-900">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 md:pt-24 md:pb-20">
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            <Badge key="펠릭스 오제-알리아심" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">펠릭스 오제-알리아심</Badge>
            <Badge key="Felix Auger-Aliassime" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">Felix Auger-Aliassime</Badge>
            <Badge key="캐나다" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">캐나다</Badge>
            <Badge key="유망주" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">유망주</Badge>
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">
            펠릭스 오제-알리아심: 캐나다의 테니스 희망
          </h1>
          <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed font-light">
            성실함과 운동 능력을 겸비한 펠릭스 오제-알리아심. 그의 강력한 포핸드와 서비스 게임, 그리고 그랜드 슬램을 향한 도전을 정리합니다.
          </p>
      ...
      <Article slug="felix-auger-aliassime" date="2026-01-24" title="펠릭스 오제-알리아심: 캐나다의 테니스 희망" excerpt="성실함과 운동 능력을 겸비한 펠릭스 오제-알리아심. 그의 강력한 포핸드와 서비스 게임, 그리고 그랜드 슬램을 향한 도전을 정리합니다.">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:border-b prose-h2:border-gray-200 dark:prose-h2:border-gray-700 prose-h2:pb-3 prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-p:leading-relaxed prose-p:text-base">
            ...
            <p>
              {"성실함과 운동 능력을 겸비한 펠릭스 오제-알리아심. 그의 강력한 포핸드와 서비스 게임, 그리고 그랜드 슬램을 향한 도전을 정리합니다."} 이 글에서는 {"테니스"}에 대해 깊이 있게 알아봅니다.
              (이곳에 서론 내용을 작성해 주세요.)
            </p>
            ...
            <p>
              지금까지 펠릭스 오제-알리아심: 캐나다의 테니스 희망에 대해 알아보았습니다. 여러분의 테니스 라이프에 도움이 되기를 바랍니다.
            </p>
