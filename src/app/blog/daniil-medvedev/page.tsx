      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h1 id="daniil-medvedev-angle-depth-possession-aesthetics">다닐 메드베데프 — 각도와 깊이로 짜는 지공의 미학</h1>

            <p><strong>직답:</strong> 다닐 메드베데프(Daniil Medvedev)는 낮은 탄도와 깊은 낙구, 독특한 코트 포지셔닝으로 상대의 선택지를 점점 좁혀 가는 현대 하드코트의 설계자다.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <ul className="space-y-1 text-sm">
                  ...
                  <li><a href="https://en.wikipedia.org/wiki/Daniil_Medvedev" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-200">위키피디아 프로필</a></li>
                </ul>
              </div>
            </div>
          </div>
