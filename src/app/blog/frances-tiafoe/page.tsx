...
export default function BlogPost() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-950 dark:via-gray-950 dark:to-blue-950">
      ...
      <Article showHeader={false} slug="frances-tiafoe" date="2026-01-24" title="프란시스 티아포: 흥이 넘치는 빅 포(Big Foe)" excerpt="코트 위를 무대로 만드는 쇼맨십. 미국 테니스의 희망 프란시스 티아포의 에너지 넘치는 플레이와 인생 스토리.">
