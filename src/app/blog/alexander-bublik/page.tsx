...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://tennisfriends.co.kr/blog/alexander-bublik',
  },
  openGraph: {
    title: "알렉산더 부블릭: 언더암 서브와 창의성",
    description: "테니스를 즐기는 방식이 남다른 알렉산더 부블릭. 언더암 서브, 변칙 플레이, 그리고 그가 추구하는 창의적인 테니스의 세계.",
...
const faqs = [
  {
    q: "알렉산더 부블릭: 언더암 서브와 창의성 관련 자주 묻는 질문 1",
    a: '이곳에 답변이 들어갑니다. 구체적이고 도움이 되는 정보를 제공하세요.'
  },
  {
    q: "알렉산더 부블릭: 언더암 서브와 창의성 관련 자주 묻는 질문 2",
      ...
      <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 dark:from-blue-900 dark:via-purple-900 dark:to-indigo-900">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 md:pt-24 md:pb-20">
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            <Badge key="알렉산더 부블릭" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">알렉산더 부블릭</Badge>
            <Badge key="Alexander Bublik" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">Alexander Bublik</Badge>
            <Badge key="언더암 서브" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">언더암 서브</Badge>
            <Badge key="변칙" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">변칙</Badge>
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">
            알렉산더 부블릭: 언더암 서브와 창의성
          </h1>
          <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed font-light">
            테니스를 즐기는 방식이 남다른 알렉산더 부블릭. 언더암 서브, 변칙 플레이, 그리고 그가 추구하는 창의적인 테니스의 세계.
          </p>
      ...
      <Article slug="alexander-bublik" date="2026-01-24" title="알렉산더 부블릭: 언더암 서브와 창의성" excerpt="테니스를 즐기는 방식이 남다른 알렉산더 부블릭. 언더암 서브, 변칙 플레이, 그리고 그가 추구하는 창의적인 테니스의 세계.">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:border-b prose-h2:border-gray-200 dark:prose-h2:border-gray-700 prose-h2:pb-3 prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-p:leading-relaxed prose-p:text-base">
            ...
            <p>
              {"테니스를 즐기는 방식이 남다른 알렉산더 부블릭. 언더암 서브, 변칙 플레이, 그리고 그가 추구하는 창의적인 테니스의 세계."} 이 글에서는 {"테니스"}에 대해 깊이 있게 알아봅니다.
              (이곳에 서론 내용을 작성해 주세요.)
            </p>
            ...
            <p>
              지금까지 알렉산더 부블릭: 언더암 서브와 창의성에 대해 알아보았습니다. 여러분의 테니스 라이프에 도움이 되기를 바랍니다.
            </p>
          ...
          <FAQ items={faqs} />
                    <RelatedPosts 
            currentSlug="alexander-bublik" 
            category="테니스" 
            tags={["테니스","알렉산더 부블릭","Alexander Bublik","언더암 서브","변칙"]} 
          />
