...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://tennisfrens.com/blog/tennis-injury-prevention-full-guide',
  },
  openGraph: {
    title: '테니스 부상 예방 루틴 | 10분 워밍업·가동성·쿨다운 완전 정리',
    description: '어깨·팔꿈치·무릎 보호를 위한 워밍업·가동성·쿨다운 3단계 루틴과 지역별 기후 대응, 부상 징후별 대처법까지.',
    url: 'https://tennisfrens.com/blog/tennis-injury-prevention-full-guide',
...
export default function TennisInjuryPreventionFullGuidePage() {
  ...
  return (
    <Article ymylTopic="medical"
      slug="tennis-injury-prevention-full-guide" date="2024-01-01" title={title} excerpt={excerpt}>
