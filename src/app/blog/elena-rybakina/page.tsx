...
const faqs = [
  {
    q: "엘레나 리바키나: 차가운 아이스 퀸의 플레이 관련 자주 묻는 질문 1",
    a: '이곳에 답변이 들어갑니다. 구체적이고 도움이 되는 정보를 제공하세요.'
  },
  {
    q: "엘레나 리바키나: 차가운 아이스 퀸의 플레이 관련 자주 묻는 질문 2",
      ...
      <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 dark:from-blue-900 dark:via-purple-900 dark:to-indigo-900">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 md:pt-24 md:pb-20">
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            <Badge key="엘레나 리바키나" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">엘레나 리바키나</Badge>
            <Badge key="Elena Rybakina" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">Elena Rybakina</Badge>
            <Badge key="Wimbledon" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">Wimbledon</Badge>
            <Badge key="서브 퀸" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">서브 퀸</Badge>
          </div>
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed font-light">
            감정을 드러내지 않는 포커페이스와 우아한 위너. 엘레나 리바키나의 간결한 스윙 메커니즘과 강력한 서브의 비결을 파헤칩니다.
          </p>
      ...
      <Article slug="elena-rybakina" date="2026-01-24" title="엘레나 리바키나: 차가운 아이스 퀸의 플레이" excerpt="감정을 드러내지 않는 포커페이스와 우아한 위너. 엘레나 리바키나의 간결한 스윙 메커니즘과 강력한 서브의 비결을 파헤칩니다.">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:border-b prose-h2:border-gray-200 dark:prose-h2:border-gray-700 prose-h2:pb-3 prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-p:leading-relaxed prose-p:text-base">
            ...
            <p>
              {"감정을 드러내지 않는 포커페이스와 우아한 위너. 엘레나 리바키나의 간결한 스윙 메커니즘과 강력한 서브의 비결을 파헤칩니다."} 이 글에서는 {"테니스"}에 대해 깊이 있게 알아봅니다.
              (이곳에 서론 내용을 작성해 주세요.)
            </p>
            ...
            <p>
              지금까지 엘레나 리바키나: 차가운 아이스 퀸의 플레이에 대해 알아보았습니다. 여러분의 테니스 라이프에 도움이 되기를 바랍니다.
            </p>
