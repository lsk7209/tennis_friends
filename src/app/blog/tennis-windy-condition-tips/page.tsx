...
const faqs = [
  {
    q: "바람이 많이 부는 날 서브 토스는 어떻게 해야 하나요?",
    a: "평소보다 **토스를 낮게** 올리는 것이 핵심입니다. 공이 공중에 오래 머물수록 바람의 영향을 많이 받으므로, 임팩트 타이밍을 빠르게 가져가고 몸 쪽으로 붙여 던져 안정성을 확보하세요."
  },
  {
    q: "맞바람(Against the Wind) 상황에서의 필승 전략은?",
    a: "맞바람에서는 공이 짧아지므로 **드롭샷**이 매우 위력적입니다. 반대로 상대의 공도 짧아지기 때문에 네트 앞으로 과감하게 대시하여 발리로 마무리하는 전략이 유효합니다."
  },
];
