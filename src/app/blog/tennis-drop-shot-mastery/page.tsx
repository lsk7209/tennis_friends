...
const faqs = [
  {
    q: "드롭샷을 구사하기 가장 좋은 타이밍은 언제인가요?",
    a: "상대가 **베이스라인 멀리 뒤로 물러났을 때**가 최적입니다. 또는 강한 샷에 밀려 상대의 중심이 뒤꿈치에 쏠려 있을 때 구사하면 반응 속도를 늦출 수 있어 성공 확률이 비약적으로 높아집니다."
  },
  {
    q: "드롭샷 실수(네트 걸림/장타)를 줄이는 그립 팁은?",
    a: "반드시 **컨티넨탈 그립**을 사용해야 합니다. 포핸드 그립으로 드롭샷을 치면 손목이 고정되어 터치감을 살리기 어렵습니다. 라켓 헤드를 열고 공 아래를 부드럽게 깎아주는 감각을 익히세요."
  },
];
