...
const faqs = [
  {
    q: '데니스 샤포발로프: 왼손 원핸드 백핸드의 낭만 관련 자주 묻는 질문 1',
    a: '이곳에 답변이 들어갑니다. 구체적이고 도움이 되는 정보를 제공하세요.'
  },
  {
    q: '데니스 샤포발로프: 왼손 원핸드 백핸드의 낭만 관련 자주 묻는 질문 2',
      ...
      <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 dark:from-blue-900 dark:via-purple-900 dark:to-indigo-900">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 md:pt-24 md:pb-20">
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            <Badge key="데니스 샤포발로프" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">데니스 샤포발로프</Badge>
            <Badge key="Denis Shapovalov" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">Denis Shapovalov</Badge>
            <Badge key="원핸드 백핸드" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">원핸드 백핸드</Badge>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">
            데니스 샤포발로프: 왼손 원핸드 백핸드의 낭만
          </h1>
          <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed font-light">
            폭발적인 점프 원핸드 백핸드의 소유자 데니스 샤포발로프. 공격적인 스타일과 화려한 샷 메이킹, 그가 보여주는 낭만 테니스.
          </p>
      ...
      <Article slug="denis-shapovalov" date="2026-01-24" title="데니스 샤포발로프: 왼손 원핸드 백핸드의 낭만" excerpt="폭발적인 점프 원핸드 백핸드의 소유자 데니스 샤포발로프. 공격적인 스타일과 화려한 샷 메이킹, 그가 보여주는 낭만 테니스.">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:border-b prose-h2:border-gray-200 dark:prose-h2:border-gray-700 prose-h2:pb-3 prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-p:leading-relaxed prose-p:text-base">
            ...
            <p>
              {"폭발적인 점프 원핸드 백핸드의 소유자 데니스 샤포발로프. 공격적인 스타일과 화려한 샷 메이킹, 그가 보여주는 낭만 테니스."} 이 글에서는 {"테니스"}에 대해 깊이 있게 알아봅니다.
              (이곳에 서론 내용을 작성해 주세요.)
            </p>
            ...
            <p>
              지금까지 데니스 샤포발로프: 왼손 원핸드 백핸드의 낭만에 대해 알아보았습니다. 여러분의 테니스 라이프에 도움이 되기를 바랍니다.
            </p>
