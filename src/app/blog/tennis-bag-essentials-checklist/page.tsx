...
const faqs = [
  {
    q: "테니스 가방(라켓백) 필수 아이템 체크리스트 관련 자주 묻는 질문 1",
    a: '이곳에 답변이 들어갑니다. 구체적이고 도움이 되는 정보를 제공하세요.'
  },
  {
    q: "테니스 가방(라켓백) 필수 아이템 체크리스트 관련 자주 묻는 질문 2",
...
export default function BlogPost() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-950 dark:via-gray-950 dark:to-blue-950">
      ...
      <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 dark:from-blue-900 dark:via-purple-900 dark:to-indigo-900">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 md:pt-24 md:pb-20">
          <div className="flex flex-wrap gap-2 mb-6">
            <Badge key="테니스 용품" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">테니스 용품</Badge>
            <Badge key="가방" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">가방</Badge>
            <Badge key="준비물" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">준비물</Badge>
            <Badge key="체크리스트" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">체크리스트</Badge>
            <Badge key="꿀팁" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">꿀팁</Badge>
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">
            테니스 가방(라켓백) 필수 아이템 체크리스트
          </h1>
          <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed font-light">
            고수들의 가방에는 무엇이 들어있을까요? 그립 파우더, 여분 양말, 비상약 등 코트 나갈 때 꼭 챙겨야 할 준비물 리스트.
          </p>
      ...
      <Article slug="tennis-bag-essentials-checklist" date="2026-01-24" title="테니스 가방(라켓백) 필수 아이템 체크리스트" excerpt="고수들의 가방에는 무엇이 들어있을까요? 그립 파우더, 여분 양말, 비상약 등 코트 나갈 때 꼭 챙겨야 할 준비물 리스트.">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:border-b prose-h2:border-gray-200 dark:prose-h2:border-gray-700 prose-h2:pb-3 prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-p:leading-relaxed prose-p:text-base">
            ...
            <p>
              {"고수들의 가방에는 무엇이 들어있을까요? 그립 파우더, 여분 양말, 비상약 등 코트 나갈 때 꼭 챙겨야 할 준비물 리스트."} 이 글에서는 {"테니스 용품"}에 대해 깊이 있게 알아봅니다.
              (이곳에 서론 내용을 작성해 주세요.)
            </p>
            ...
            <p>
              지금까지 테니스 가방(라켓백) 필수 아이템 체크리스트에 대해 알아보았습니다. 여러분의 테니스 라이프에 도움이 되기를 바랍니다.
            </p>
