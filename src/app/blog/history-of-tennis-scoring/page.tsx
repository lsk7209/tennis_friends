...
const faqs = [
  {
    q: "테니스 점수(0, 15, 30, 40)의 유래와 역사 관련 자주 묻는 질문 1",
    a: '이곳에 답변이 들어갑니다. 구체적이고 도움이 되는 정보를 제공하세요.'
  },
  {
    q: "테니스 점수(0, 15, 30, 40)의 유래와 역사 관련 자주 묻는 질문 2",
...
export default function BlogPost() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-950 dark:via-gray-950 dark:to-blue-950">
      ...
      <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 dark:from-blue-900 dark:via-purple-900 dark:to-indigo-900">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 md:pt-24 md:pb-20">
          <div className="flex flex-wrap gap-2 mb-6">
            <Badge key="테니스 역사" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">테니스 역사</Badge>
            <Badge key="점수 룰" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">점수 룰</Badge>
            <Badge key="15 30 40" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">15 30 40</Badge>
            <Badge key="Love" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">Love</Badge>
            <Badge key="상식" className="bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">상식</Badge>
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">
            테니스 점수(0, 15, 30, 40)의 유래와 역사
          </h1>
          <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed font-light">
            왜 1, 2, 3이 아닐까요? 러브(Love)는 어디서 왔을까요? 중세 프랑스 귀족 놀이에서 유래한 독특한 점수 체계의 비밀.
          </p>
      ...
      <Article slug="history-of-tennis-scoring" date="2026-01-24" title="테니스 점수(0, 15, 30, 40)의 유래와 역사" excerpt="왜 1, 2, 3이 아닐까요? 러브(Love)는 어디서 왔을까요? 중세 프랑스 귀족 놀이에서 유래한 독특한 점수 체계의 비밀.">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:border-b prose-h2:border-gray-200 dark:prose-h2:border-gray-700 prose-h2:pb-3 prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-p:leading-relaxed prose-p:text-base">
            ...
            <p>
              {"왜 1, 2, 3이 아닐까요? 러브(Love)는 어디서 왔을까요? 중세 프랑스 귀족 놀이에서 유래한 독특한 점수 체계의 비밀."} 이 글에서는 {"테니스 역사"}에 대해 깊이 있게 알아봅니다.
              (이곳에 서론 내용을 작성해 주세요.)
            </p>
            ...
            <p>
              지금까지 테니스 점수(0, 15, 30, 40)의 유래와 역사에 대해 알아보았습니다. 여러분의 테니스 라이프에 도움이 되기를 바랍니다.
            </p>
