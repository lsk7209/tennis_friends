...
export default function TaylorFritzBlogPost() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-blue-950 dark:via-gray-900 dark:to-purple-950">
      <Article
        title="테일러 프리츠 — 직선의 파워, 계산된 각"
        excerpt="단단한 포핸드와 안정된 서브, 계산된 코스 선택으로 큰 코트의 시간을 단축하는 테일러 프리츠의 배경·스타일·과제를 정리했다."
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h1 id="taylor-fritz-straight-power-calculated-angle">테일러 프리츠 — 직선의 파워, 계산된 각</h1>

            <p><strong>직답:</strong> 테일러 프리츠(Taylor Fritz)는 직선 압박의 포핸드와 안정된 퍼스트 서브, 계산된 코스 선택으로 큰 코트의 시간을 압축하는 미국의 간판이다.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <ul className="space-y-1 text-sm">
                  ...
                  <li><a href="https://en.wikipedia.org/wiki/Taylor_Fritz" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-200">위키피디아 프로필</a></li>
                </ul>
              </div>
            </div>
          </div>
