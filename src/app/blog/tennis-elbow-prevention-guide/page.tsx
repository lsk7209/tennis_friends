...
const tocItems: Array<{ id: string; text: string; depth: 2 | 3 }> = [
  {
    id: "what-is-tennis-elbow",
    text: "1. 테니스 엘보란? (증상 자가진단)",
    depth: 2,
  },
  { id: "causes", text: "2. 왜 생길까? (잘못된 자세 vs 장비)", depth: 2 },
  {
    id: "equipment-solution",
    text: "3. 장비로 해결하기 (라켓, 스트링, 댐퍼)",
    depth: 2,
  },
    ...
    >
      <div className="bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-950 dark:to-pink-950 p-6 rounded-lg mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          "악!" 임팩트 순간 팔꿈치에 전해지는 찌릿한 통증. 테니스인이라면 누구나
          두려워하는 그 이름, **테니스 엘보(Tennis Elbow)**입니다. 한 번 오면
          쉽게 낫지 않는 이 불청객을 어떻게 예방하고 관리해야 할까요?
        </p>
      </div>
      ...
      <section id="what-is-tennis-elbow" className="mb-12">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          정식 명칭은 '외측상과염'. 팔꿈치 바깥쪽 뼈에 붙은 힘줄이 과도한 힘이나
          반복적인 충격으로 미세 파열되어 염증이 생긴 상태입니다.
        </p>
          ...
          <Card className="bg-white dark:bg-gray-800">
            <CardContent className="p-5">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                가장 큰 원인입니다. 몸통 회전(코어)을 쓰지 않고{" "}
                <strong>"팔로만 치는 스윙"</strong>이 주범입니다. 특히
                입문자들이 공을 세게 치려고 손목을 무리하게 꺾거나, 타점이
                늦었을 때 억지로 넘기려다 다칩니다.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="space-y-4">
          <div className="flex gap-4 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                강성(Stiffness/RA)이 낮은 라켓을 찾으세요. 윌슨 클래시(Clash),
                헤드 붐(Boom), 프로케넥스 등이 팔이 편하기로 유명합니다. 무게도
                너무 가볍기보다는 적당한 무게(290~300g)가 충격을 흡수해줍니다.
              </p>
            </div>
          </div>
          <div className="flex gap-4 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                가장 저렴하고 효과적인 방법입니다. 딱딱한 폴리 대신
                **멀티필라멘트**로 바꾸고, 텐션을 40~44lbs까지 과감하게
                낮추세요. 공이 펑펑 날린다면 스윙을 더 부드럽게 가져가면 됩니다.
              </p>
          ...
          <div className="flex gap-4 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                진동 감쇠기(댐퍼)는 타구음(소리)을 잡아줄 뿐, 팔로 전달되는 실제
                충격량을 유의미하게 줄여주지는 못한다는 연구 결과가 많습니다.
                심리적 위안 효과는 있습니다.
              </p>
            </div>
          </div>
          ...
          <Card className="bg-white dark:bg-gray-800 overflow-hidden">
            <div className="h-40 bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-400">
              ...
              <span className="text-gray-500 font-medium">
                손목 신전 스트레칭 등 이미지 업데이트 예정
              </span>
            </div>
            <CardContent className="p-4">
              <h3 className="font-bold mb-2">1. 손목 신전 스트레칭</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                팔을 앞으로 쭉 뻗고 손등을 반대 손으로 몸 쪽으로 당겨줍니다.
                팔꿈치 바깥쪽이 당기는 느낌이 들어야 합니다. (15초 유지 x 3회)
              </p>
            </CardContent>
          </Card>
          <Card className="bg-white dark:bg-gray-800 overflow-hidden">
            ...
            <CardContent className="p-4">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                말랑한 고무공을 쥐었다 폈다 하거나, 가벼운 아령(1~2kg)으로
                손목을 위아래로 까딱거리는 운동(손목 컬)을 꾸준히 해주세요.
                근육이 충격을 대신 흡수해줍니다.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="bg-purple-50 dark:bg-purple-950/30 p-6 rounded-lg">
          <ul className="space-y-4">
            <li className="flex items-start gap-3">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                팔꿈치 바로 아래 근육을 꽉 압박해 힘줄로 가는 진동을 차단합니다.
                가장 대중적이고 효과적입니다. (추천: 잠스트, 나이키)
              </p>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-purple-600 dark:text-purple-400 font-bold">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                전체적인 보온과 압박을 해줍니다. 예방용으로는 좋지만, 통증이
                이미 있다면 밴드형이 낫습니다.
              </p>
            </li>
          </ul>
      ...
      <section id="conclusion" className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
          <span className="bg-gray-800 text-white rounded-lg w-8 h-8 flex items-center justify-center text-sm font-bold">
            6
          </span>
          결론 — 아프면 쉬는 게 정답
        </h2>
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          테니스는 평생 할 수 있는 운동입니다. 당장 코트에 나가고 싶은 마음은
          알지만, 통증을 무시하면 영영 라켓을 못 잡을 수도 있습니다. 충분한
          휴식과 장비 점검, 그리고 올바른 자세 교정이 엘보 탈출의 유일한
          지름길입니다.
        </p>

        <div className="mt-8 text-center">
          <Link
            href="/blog/tennis-lesson-cost-guide"
            className="inline-block bg-white border border-gray-300 hover:bg-gray-50 text-gray-800 font-bold py-3 px-8 rounded-full transition"
          >
            제대로 된 레슨 찾기
          </Link>
        </div>
