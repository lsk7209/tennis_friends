...
const content = {
  ...
  "sections": [
    {
      ...
      "title": "핵심 원리",
      "paragraphs": [
        "포핸드 깊이 조절 가이드를 잘하는 선수는 새로운 기술을 하나 더 갖춘 선수가 아니라, 흔들릴 때도 기준을 유지하는 선수입니다. 강타보다 길이 만들기이 정리돼 있으면 점수와 상대 스타일이 바뀌어도 첫 판단이 무너지지 않습니다.",
  ...
  "faq": [
    {
      "question": "포핸드 깊이 조절 가이드는 얼마나 자주 연습해야 하나요?",
