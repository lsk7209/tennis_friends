...
export const metadata: Metadata = {
  title: "수면과 테니스 회복 가이드",
  description: "테니스 경기력과 회복 속도에 영향을 주는 수면 준비와 취침 루틴을 설명합니다.",
  alternates: {
    canonical: `${siteUrl}/blog/tennis-sleep-recovery-guide`,
  },
  openGraph: {
    title: "수면과 테니스 회복 가이드",
    description: "테니스 경기력과 회복 속도에 영향을 주는 수면 준비와 취침 루틴을 설명합니다.",
    url: `${siteUrl}/blog/tennis-sleep-recovery-guide`,
    type: "article",
...
const content = {
  "intro": "테니스 경기력과 회복 속도에 영향을 주는 수면 준비와 취침 루틴을 설명합니다. 이 글은 특히 야간 경기 후 잠이 늦게 드는 장면에서 흔들리는 동호인 기준으로, 무엇을 먼저 정리해야 하는지와 어떻게 반복해야 하는지를 실전 언어로 설명합니다.",
  "summaryBox": "핵심은 취침 전 회복 설계입니다. 좋은 날의 감각이 아니라 반복 가능한 구조를 만들어야 경기에서도 유지됩니다.",
  "keyPoints": [
    "수면과 테니스 회복 가이드의 차이는 화려함보다 재현 가능한 기준을 만드는 데서 납니다.",
    "대표 장면은 야간 경기 후 잠이 늦게 드는 장면입니다. 이때 선택 구조가 단순해야 범실이 줄어듭니다.",
    "기상 시 피로도을 추적하면 감각이 아니라 실제 변화를 확인할 수 있습니다."
  ],
  "sections": [
    {
      "id": "principle",
      "title": "핵심 원리",
      "paragraphs": [
        "수면과 테니스 회복 가이드를 잘하는 선수는 새로운 기술을 하나 더 갖춘 선수가 아니라, 흔들릴 때도 기준을 유지하는 선수입니다. 취침 전 회복 설계이 정리돼 있으면 점수와 상대 스타일이 바뀌어도 첫 판단이 무너지지 않습니다.",
    ...
    },
    {
      ...
      "title": "실전 적용 장면",
      "paragraphs": [
        "야간 경기 후 잠이 늦게 드는 장면은 많은 동호인이 실제 경기에서 겪는 문제입니다. 이때는 스윙 전체를 바꾸기보다 준비 타이밍, 높이, 목표 구역 중 하나를 먼저 고정해야 합니다.",
    ...
    },
    {
      ...
      "title": "권장 연습 루틴",
      "paragraphs": [
        "가장 효율적인 드릴은 샤워와 화면 차단 루틴입니다. 핵심은 보기 좋은 훈련이 아니라 핵심 감각이 무너지지 않도록 조건을 제한하는 것입니다.",
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "그래서 리뷰 기준도 단순해야 합니다. 오늘은 기상 시 피로도 하나만 본다고 정해두면, 다음 연습에서 무엇을 반복할지 빠르게 결정할 수 있습니다."
      ]
    }
  ],
  "checklist": [
    "오늘 연습 목표를 \"취침 전 회복 설계\" 한 문장으로 적었다.",
    "야간 경기 후 잠이 늦게 드는 장면을 가정한 상황 훈련을 넣었다.",
    "기상 시 피로도을 확인할 기록 기준을 정했다.",
    "마지막 10분은 점수 조건을 걸고 실전 전환까지 확인했다."
  ],
  "faq": [
    {
      "question": "수면과 테니스 회복 가이드는 얼마나 자주 연습해야 하나요?",
      "answer": "짧게라도 주 2~3회 반복하는 편이 좋습니다. 특히 기상 시 피로도을 같이 기록하면 감각이 아니라 실제 변화를 추적하기 쉽습니다."
    },
    {
  ...
  "nextAction": "다음 세션에서는 샤워와 화면 차단 루틴을 20분만 실행하고, 끝난 뒤 기상 시 피로도 하나만 기록해 보세요.",
  "utility": "/utility/sleep-readiness-check",
  "utilityLabel": "수면 준비도 체크"
} as const;
