...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://tennisfrens.com/blog/tennis-shoes-balance-guide',
  },
  openGraph: {
    title: '테니스화 선택 완전 가이드 | 접지·지지·쿠션·사이징 균형법',
    description: '하드·클레이·올코트별 아웃솔 차이, 평발/요족 맞춤 인솔, 지역별 기후 조건과 교체 주기까지 완전 정리.',
    url: 'https://tennisfrens.com/blog/tennis-shoes-balance-guide',
...
export default function TennisShoesBalanceGuidePage() {
  ...
  return (
    <Article slug="tennis-shoes-balance-guide" date="2024-01-01" title={title} excerpt={excerpt}>
