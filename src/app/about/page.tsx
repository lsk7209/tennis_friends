...
export const metadata: Metadata = {
  ...
  description:
    "TennisFriends는 데이터 기반의 정확한 분석과 전문적인 정보로 테니스 실력 향상을 돕는 종합 플랫폼입니다. NTRP 실력 테스트, 스트링 텐션 계산기, 부상 위험도 평가 등 다양한 도구를 제공합니다.",
  keywords: [
    "TennisFriends",
    "테니스 플랫폼",
    "테니스 커뮤니티",
  ...
  const editorialStandards = [
    {
      title: "근거 기반 작성",
      description:
        "ITF 공식 규정, 학술 논문, 공신력 있는 스포츠 의학 자료를 우선 인용합니다.",
    },
    {
      title: "출처 명시",
      description:
        "수치·통계·규정을 인용할 때는 가능한 범위에서 원문 링크 또는 출처를 함께 표기합니다.",
    },
    {
      title: "주기적 업데이트",
      description:
        "규정·장비·코트 정보 등 시간이 지나며 바뀌는 내용은 확인될 때마다 수정일을 갱신합니다.",
    },
  ];
  ...
  const values = [
    {
      ...
      title: "열정",
      description:
        "테니스에 대한 진정한 사랑과 열정으로 모든 서비스를 제공합니다.",
    },
    {
      icon: Target,
      title: "정확성",
      description:
        "데이터 기반의 정확한 분석과 신뢰할 수 있는 정보를 제공합니다.",
    },
    {
      icon: Users,
      title: "커뮤니티",
      description:
        "테니스 동호인들이 함께 성장할 수 있는 커뮤니티를 만들어갑니다.",
    },
    {
      icon: Award,
      title: "전문성",
      ...
      <Card className="bg-content-dark border-white/10 mb-16">
        <CardContent className="p-8">
          ...
          <div className="text-text-muted text-sm leading-relaxed space-y-3 max-w-3xl mx-auto">
            ...
            <p>
              실제 코칭, 의료 진단, 개인 맞춤 처방을 대체할 수 없으며, 구체적인
              상담이 필요한 경우 자격을 갖춘 코치·의료진과 직접 상담하시기
              바랍니다.
            </p>
          </div>
        </CardContent>
