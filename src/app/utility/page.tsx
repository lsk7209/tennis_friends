...
export const utilitiesMetadata: UtilityMetadata[] = [
  ...
  },
  {
    ...
    title: '샷 선택 트레이너',
    description: '공의 높이, 깊이, 코트 위치에 따라 최적의 샷을 선택하는 연습을 합니다.',
    icon: Target,
    status: '완료',
  ...
  },
  {
    ...
    description: '고압 상황의 타이브레이크 포인트에서 루틴과 의사결정을 훈련합니다.',
    icon: Brain,
    status: '완료',
  ...
  },
  {
    ...
    title: '리턴 포지션 계산기',
    description: '서브 속도와 코트 서피스에 따라 최적의 리턴 깊이를 계산합니다.',
    icon: Gauge,
    status: '완료',
  ...
  },
  {
    ...
    title: '경기일 준비물 체크리스트',
    description: '라켓, 의류, 수분 보충, 회복 장비 등 경기일 준비물을 체계적으로 관리합니다.',
    icon: CheckCircle,
    status: '완료',
  ...
  },
  {
    ...
    title: '수분 보충 플래너',
    description: '날씨와 경기 시간에 따라 필요한 수분 및 전해질 섭취량을 계산합니다.',
    icon: Waves,
    status: '완료',
  ...
  },
  {
    ...
    title: '회복 루틴 생성기',
    description: '경기 후 운동 부하와 신체 상태에 맞는 회복 루틴을 자동 생성합니다.',
    icon: Heart,
    status: '완료',
  ...
  },
  {
    ...
    title: '연습 드릴 생성기',
    description: '일관성과 패턴 플레이를 위한 집중 훈련 세션을 자동 생성합니다.',
    icon: Sparkles,
    status: '완료',
  ...
  },
  {
    ...
    title: '벽치기 훈련 플래너',
    description: '반복 횟수, 시간, 스트로크 포커스로 솔로 벽치기 훈련을 계획합니다.',
    icon: FileText,
    status: '완료',
  ...
  },
  {
    ...
    title: '경기 영상 리뷰 템플릿',
    description: '경기 영상 리뷰 시 전술과 의사결정 패턴을 체계적으로 기록합니다.',
    icon: Video,
    status: '완료',
  ...
  },
  {
    ...
    title: '그립 사이즈 체커',
    description: '손 치수와 그립감 선호도를 기반으로 최적의 그립 사이즈를 추정합니다.',
    icon: Hand,
    status: '완료',
  ...
  },
  {
    ...
    title: '테니스화 마모 트래커',
    description: '아웃솔 마모와 지지력 저하를 모니터링하여 교체 시기를 판단합니다.',
    icon: Footprints,
    status: '완료',
  ...
  },
  {
    ...
    title: '성인 입문자 로드맵',
    description: '테니스를 처음 시작하는 성인을 위한 첫 3개월 현실적 목표를 설정합니다.',
    icon: BookOpen,
    status: '완료',
  ...
  },
  {
    ...
    title: '테니스 시간 플래너',
    description: '직장, 출장, 회복 부하를 고려하여 주간 테니스 시간을 계획합니다.',
    icon: Clock,
    status: '완료',
