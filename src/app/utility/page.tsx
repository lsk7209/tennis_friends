...
export const utilitiesMetadata: UtilityMetadata[] = [
  ...
  ,
  {
    id: 'doubles-positioning-simulator',
    title: 'Doubles Positioning Simulator',
    description: 'Model common doubles formations and spacing choices.',
    icon: Users,
    status: '완료',
    features: ['Formations', 'Spacing', 'Roles', 'Scenarios'],
    gradient: 'from-sky-500 via-blue-500 to-indigo-500',
    bgColor: 'bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50',
    iconBg: 'bg-gradient-to-br from-sky-500 to-blue-500',
    category: 'Doubles'
  ...
  {
    id: 'shot-selection-trainer',
    title: 'Shot Selection Trainer',
    description: 'Practice better decisions by ball height, depth, and court position.',
    icon: Target,
    status: '완료',
    features: ['Decision drills', 'Risk control', 'Patterns', 'Review'],
    gradient: 'from-red-500 via-orange-500 to-amber-500',
    bgColor: 'bg-gradient-to-br from-red-50 via-orange-50 to-amber-50',
    iconBg: 'bg-gradient-to-br from-red-500 to-orange-500',
    category: 'Strategy'
  ...
  {
    id: 'tiebreak-pressure-simulator',
    title: 'Tiebreak Pressure Simulator',
    description: 'Train routines and choices for high-pressure tiebreak points.',
    icon: Brain,
    status: '완료',
    features: ['Pressure mode', 'Score states', 'Routines', 'Notes'],
    gradient: 'from-violet-500 via-purple-500 to-fuchsia-500',
    bgColor: 'bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50',
    iconBg: 'bg-gradient-to-br from-violet-500 to-purple-500',
    category: 'Mental'
  ...
  {
    id: 'serve-placement-mapper',
    title: 'Serve Placement Mapper',
    description: 'Map first and second serve targets by score and side.',
    icon: Crosshair,
    status: '완료',
    features: ['Target zones', 'Deuce/ad', 'Serve plans', 'Exports'],
    gradient: 'from-blue-500 via-cyan-500 to-teal-500',
    bgColor: 'bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50',
    iconBg: 'bg-gradient-to-br from-blue-500 to-cyan-500',
    category: 'Serve'
  ...
  {
    id: 'return-position-calculator',
    title: 'Return Position Calculator',
    description: 'Estimate better return depth from serve speed and surface.',
    icon: Gauge,
    status: '완료',
    features: ['Serve speed', 'Surface mode', 'Depth range', 'Tips'],
    gradient: 'from-emerald-500 via-green-500 to-lime-500',
    bgColor: 'bg-gradient-to-br from-emerald-50 via-green-50 to-lime-50',
    iconBg: 'bg-gradient-to-br from-emerald-500 to-green-500',
    category: 'Return'
  ...
  {
    id: 'matchday-packing-checklist',
    title: 'Matchday Packing Checklist',
    description: 'Build a repeatable list for rackets, clothes, hydration, and recovery gear.',
    icon: CheckCircle,
    status: '완료',
    features: ['Custom lists', 'Weather presets', 'Reminders', 'Travel mode'],
  ...
  {
    id: 'hydration-planner',
    title: 'Hydration Planner',
    description: 'Estimate fluid and electrolyte needs by weather and match length.',
    icon: Waves,
    status: '완료',
    features: ['Fluid targets', 'Heat mode', 'Electrolytes', 'Tracking'],
  ...
  {
    id: 'sleep-readiness-check',
    title: 'Sleep Readiness Check',
    description: 'Review sleep quality before a match or heavy practice session.',
    icon: Moon,
    status: '완료',
    features: ['Readiness score', 'Sleep prompts', 'Flags', 'Suggestions'],
    gradient: 'from-indigo-500 via-blue-500 to-slate-500',
    bgColor: 'bg-gradient-to-br from-indigo-50 via-blue-50 to-slate-50',
    iconBg: 'bg-gradient-to-br from-indigo-500 to-blue-500',
    category: 'Recovery'
  },
  {
    id: 'recovery-routine-generator',
    title: 'Recovery Routine Generator',
    description: 'Generate a post-match recovery plan from load and body condition.',
    icon: Heart,
    status: '완료',
    features: ['Load-based plans', 'Mobility', 'Flags', 'Timing'],
  ...
  {
    id: 'warmup-routine-builder',
    title: 'Warmup Routine Builder',
    description: 'Create a match-ready warmup sequence by time and goal.',
    icon: Flame,
    status: '완료',
    features: ['Time presets', 'Mobility', 'Activation', 'Court flow'],
    gradient: 'from-orange-500 via-red-500 to-pink-500',
    bgColor: 'bg-gradient-to-br from-orange-50 via-red-50 to-pink-50',
    iconBg: 'bg-gradient-to-br from-orange-500 to-red-500',
    category: 'Training'
  ...
  {
    id: 'cooldown-routine-builder',
    title: 'Cooldown Routine Builder',
    description: 'Build a cooldown sequence to reduce fatigue after play.',
    icon: Activity,
    status: '완료',
    features: ['Stretch menu', 'Recovery blocks', 'Time plans', 'Prep'],
    gradient: 'from-teal-500 via-emerald-500 to-green-500',
    bgColor: 'bg-gradient-to-br from-teal-50 via-emerald-50 to-green-50',
    iconBg: 'bg-gradient-to-br from-teal-500 to-emerald-500',
    category: 'Recovery'
  },
  {
    id: 'practice-drill-generator',
    title: 'Practice Drill Generator',
    description: 'Generate focused sessions for consistency and pattern play.',
    icon: Sparkles,
    status: '완료',
    features: ['Goal drills', 'Progressions', 'Partner mode', 'Templates'],
  ...
  {
    id: 'practice-wall-drill-planner',
    title: 'Wall Drill Planner',
    description: 'Plan solo wall sessions with reps, timing, and stroke focus.',
    icon: FileText,
    status: '완료',
    features: ['Solo mode', 'Rep goals', 'Stroke focus', 'Intervals'],
    gradient: 'from-amber-500 via-yellow-500 to-orange-500',
    bgColor: 'bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50',
    iconBg: 'bg-gradient-to-br from-amber-500 to-yellow-500',
    category: 'Training'
  ...
  {
    id: 'tournament-budget-calculator',
    title: 'Tournament Budget Calculator',
    description: 'Estimate event costs for travel, lodging, gear, and meals.',
    icon: Calculator,
    status: '완료',
    features: ['Cost buckets', 'Travel totals', 'Limits', 'Compare'],
    gradient: 'from-green-500 via-emerald-500 to-teal-500',
    bgColor: 'bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50',
    iconBg: 'bg-gradient-to-br from-green-500 to-emerald-500',
    category: 'Planning'
  },
  {
    ...
    description: 'Match training focus and gear choices to each court surface.',
    icon: MapPin,
    status: '완료',
    features: ['Surface presets', 'Training notes', 'Gear notes', 'Movement'],
    gradient: 'from-lime-500 via-green-500 to-emerald-500',
    bgColor: 'bg-gradient-to-br from-lime-50 via-green-50 to-emerald-50',
    iconBg: 'bg-gradient-to-br from-lime-500 to-green-500',
    category: 'Strategy'
  ...
  {
    id: 'rally-consistency-tracker',
    title: 'Rally Consistency Tracker',
    description: 'Track rally length, errors, and success trends over time.',
    icon: BarChart,
    status: '완료',
    features: ['Rally counts', 'Error logs', 'Trend view', 'History'],
  ...
  {
    id: 'unforced-error-audit',
    title: 'Unforced Error Audit',
    description: 'Audit error patterns by stroke, zone, and score state.',
    icon: AlertTriangle,
    status: '완료',
    features: ['Error buckets', 'Context tags', 'Patterns', 'Actions'],
  ...
  {
    id: 'match-video-review-template',
    title: 'Match Video Review Template',
    description: 'Capture tactical and decision patterns from match video review.',
    icon: Video,
    status: '완료',
    features: ['Review prompts', 'Tags', 'Notes', 'Summary'],
    gradient: 'from-fuchsia-500 via-pink-500 to-rose-500',
    bgColor: 'bg-gradient-to-br from-fuchsia-50 via-pink-50 to-rose-50',
    iconBg: 'bg-gradient-to-br from-fuchsia-500 to-pink-500',
    category: 'Analysis'
  ...
  {
    id: 'tennis-goal-streak-tracker',
    title: 'Goal Streak Tracker',
    description: 'Track habits and short-term goals across training weeks.',
    icon: Calendar,
    status: '완료',
    features: ['Habit streaks', 'Weekly goals', 'Progress', 'Reminders'],
    gradient: 'from-violet-500 via-purple-500 to-indigo-500',
    bgColor: 'bg-gradient-to-br from-violet-50 via-purple-50 to-indigo-50',
    iconBg: 'bg-gradient-to-br from-violet-500 to-purple-500',
    category: 'Habit'
  },
  {
    ...
    description: 'Schedule stringing, grip changes, and shoe checks in one place.',
    icon: Settings2,
    status: '완료',
    features: ['Cycles', 'Reminders', 'Usage logs', 'Notes'],
    gradient: 'from-slate-500 via-gray-500 to-zinc-500',
    bgColor: 'bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-50',
    iconBg: 'bg-gradient-to-br from-slate-500 to-gray-500',
    category: 'Equipment'
  ...
  {
    id: 'grip-size-checker',
    title: 'Grip Size Checker',
    description: 'Estimate grip size using hand measurements and feel preference.',
    icon: Hand,
    status: '완료',
    features: ['Hand sizing', 'Fit guide', 'Comfort', 'Tips'],
    gradient: 'from-cyan-500 via-blue-500 to-indigo-500',
    bgColor: 'bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-50',
    iconBg: 'bg-gradient-to-br from-cyan-500 to-blue-500',
    category: 'Equipment'
  ...
  {
    id: 'overgrip-replacement-reminder',
    title: 'Overgrip Replacement Reminder',
    description: 'Set reminders for overgrip changes based on usage and conditions.',
    icon: RotateCcw,
    status: '완료',
    features: ['Usage reminders', 'Humidity notes', 'Wear tracking', 'Timing'],
    gradient: 'from-green-500 via-teal-500 to-cyan-500',
    bgColor: 'bg-gradient-to-br from-green-50 via-teal-50 to-cyan-50',
    iconBg: 'bg-gradient-to-br from-green-500 to-teal-500',
    category: 'Equipment'
  },
  {
    id: 'string-replacement-reminder',
    title: 'String Replacement Reminder',
    description: 'Track hit volume and string condition to avoid dead string beds.',
    icon: Clock,
    status: '완료',
    features: ['Hit count', 'Tension notes', 'Alerts', 'History'],
  ...
  {
    id: 'shoe-wear-tracker',
    title: 'Shoe Wear Tracker',
    description: 'Monitor outsole wear and support breakdown to time replacement.',
    icon: Footprints,
    status: '완료',
    features: ['Wear markers', 'Mileage logs', 'Surface notes', 'Prompts'],
    gradient: 'from-indigo-500 via-purple-500 to-pink-500',
    bgColor: 'bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50',
    iconBg: 'bg-gradient-to-br from-indigo-500 to-purple-500',
    category: 'Equipment'
  },
  {
    ...
    title: 'Doubles Chemistry Test',
    description: 'Check communication style and role balance for doubles pairings.',
    icon: Users,
    status: '완료',
    features: ['Pairing test', 'Role fit', 'Style match', 'Scores'],
    gradient: 'from-pink-500 via-rose-500 to-red-500',
    bgColor: 'bg-gradient-to-br from-pink-50 via-rose-50 to-red-50',
    iconBg: 'bg-gradient-to-br from-pink-500 to-rose-500',
    category: 'Doubles'
  ...
  {
    id: 'partner-compatibility-check',
    title: 'Partner Compatibility Check',
    description: 'Compare tempo, positioning, and tactical tendencies between partners.',
    icon: Heart,
    status: '완료',
    features: ['Compatibility', 'Style compare', 'Flags', 'Tips'],
    gradient: 'from-rose-500 via-pink-500 to-fuchsia-500',
    bgColor: 'bg-gradient-to-br from-rose-50 via-pink-50 to-fuchsia-50',
    iconBg: 'bg-gradient-to-br from-rose-500 to-pink-500',
    category: 'Doubles'
  ...
  {
    id: 'junior-development-roadmap',
    title: 'Junior Development Roadmap',
    description: 'Outline age-appropriate priorities for junior tennis growth.',
    icon: School,
    status: '완료',
    features: ['Age stages', 'Skill focus', 'Competition', 'Guidance'],
    gradient: 'from-blue-500 via-sky-500 to-cyan-500',
    bgColor: 'bg-gradient-to-br from-blue-50 via-sky-50 to-cyan-50',
    iconBg: 'bg-gradient-to-br from-blue-500 to-sky-500',
    category: 'Training'
  },
  {
    id: 'adult-beginner-roadmap',
    title: 'Adult Beginner Roadmap',
    description: 'Set realistic milestones for the first months of tennis training.',
    icon: BookOpen,
    status: '완료',
    features: ['90-day plan', 'Stages', 'Drills', 'Goals'],
    gradient: 'from-emerald-500 via-green-500 to-lime-500',
    bgColor: 'bg-gradient-to-br from-emerald-50 via-green-50 to-lime-50',
    iconBg: 'bg-gradient-to-br from-emerald-500 to-green-500',
    category: 'Beginner'
  ...
  {
    id: 'tennis-time-availability-planner',
    title: 'Tennis Time Planner',
    description: 'Plan weekly tennis time around work, travel, and recovery load.',
    icon: Clock,
    status: '완료',
    features: ['Weekly plan', 'Load balance', 'Recovery slots', 'View'],
    gradient: 'from-slate-500 via-blue-500 to-indigo-500',
    bgColor: 'bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50',
    iconBg: 'bg-gradient-to-br from-slate-500 to-blue-500',
    category: 'Planning'
  },
  {
    id: 'travel-pack-planner',
    title: 'Travel Pack Planner',
    description: 'Build a travel packing list for tournaments and weekend trips.',
    icon: MapPin,
    status: '완료',
    features: ['Trip presets', 'Packing lists', 'Weather add-ons', 'Reminders'],
    gradient: 'from-cyan-500 via-teal-500 to-emerald-500',
    bgColor: 'bg-gradient-to-br from-cyan-50 via-teal-50 to-emerald-50',
    iconBg: 'bg-gradient-to-br from-cyan-500 to-teal-500',
    category: 'Planning'
  }
];
