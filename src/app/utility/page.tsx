...
export const utilitiesMetadata: UtilityMetadata[] = [
  {
    ...
    description:
      "7가지 플레이 스타일 중 당신의 고유한 테니스 성향을 발견하고 맞춤형 조언을 받으세요.",
    icon: Sparkles,
    status: "완료",
    features: [
      "7가지 스타일",
  ...
  },
  {
    ...
    title: "UTR 레이팅 계산기",
    description:
      "경기 결과를 입력하면 예상 UTR(Universal Tennis Rating)을 계산해드립니다.",
    icon: Calculator,
    status: "완료",
  ...
  },
  {
    ...
    title: "AI 테니스화 추천기",
    description:
      "발 모양과 플레이 스타일을 분석하여 최적의 테니스화를 추천해드립니다.",
    icon: Footprints,
    status: "완료",
  ...
  },
  {
    ...
    title: "테니스 칼로리 계산기",
    description:
      "운동 강도와 시간을 고려하여 정확한 칼로리 소모량을 계산해드립니다.",
    icon: Flame,
    status: "완료",
  ...
  },
  {
    ...
    title: "스트링 텐션 계산기",
    description:
      "라켓, 스트링, 플레이 스타일에 따라 최적의 텐션을 계산해드립니다.",
    icon: Settings,
    status: "완료",
  ...
  },
  {
    ...
    title: "부상 위험 예측",
    description:
      "데이터 기반 분석으로 부상 위험도를 체크하고 안전한 플레이를 위한 조언을 받으세요.",
    icon: Shield,
    status: "완료",
  ...
  },
  {
    ...
    title: "장비 추천 시스템",
    description:
      "플레이 스타일과 실력에 맞는 최적의 라켓과 스트링을 추천해드립니다.",
    icon: Target,
    status: "완료",
  ...
  },
  {
    ...
    title: "경기 분석 도구",
    description:
      "경기 데이터를 분석하여 전술적 개선점을 찾아보세요. 서브, 리턴, 네트 플레이 등 세부 통계를 분석하여 경기력을 객관적으로 평가합니다.",
    icon: TrendingUp,
    status: "완료",
  ...
  },
  {
    ...
    title: "멘탈 트레이닝",
    description:
      "경기 중 집중력과 멘탈 강화를 위한 심리적 훈련 프로그램입니다.",
    icon: Brain,
    status: "완료",
  ...
  },
  {
    ...
    title: "스트링 패턴 분석기",
    description:
      "라켓의 스트링 패턴(16x19, 18x20 등)을 분석하고 플레이 스타일에 맞는 최적의 선택을 도와드립니다.",
    icon: Target,
    status: "완료",
  ...
  },
  {
    ...
    title: "유연성 테스트",
    description:
      "테니스에 필요한 관절 가동범위를 측정하고 개선 방법을 제시합니다.",
    icon: Activity,
    status: "완료",
    features: [
      "관절 가동범위 측정",
  ...
  },
  {
    ...
    title: "복식 포지셔닝 시뮬레이터",
    description: "복식 경기의 주요 포메이션과 간격 배치를 시뮬레이션합니다.",
    icon: Users,
    status: "완료",
    features: ["포메이션 분석", "간격 조절", "역할 분배", "상황별 시나리오"],
    gradient: "from-sky-500 via-blue-500 to-indigo-500",
    bgColor: "bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50",
    iconBg: "bg-gradient-to-br from-sky-500 to-blue-500",
    category: "복식 전략",
  },
  {
    ...
    title: "샷 선택 트레이너",
    description:
      "공의 높이, 깊이, 코트 위치에 따라 최적의 샷을 선택하는 연습을 합니다.",
    icon: Target,
    status: "완료",
    features: ["의사결정 훈련", "리스크 관리", "패턴 분석", "복습 모드"],
    gradient: "from-red-500 via-orange-500 to-amber-500",
    bgColor: "bg-gradient-to-br from-red-50 via-orange-50 to-amber-50",
    iconBg: "bg-gradient-to-br from-red-500 to-orange-500",
    category: "전략 훈련",
  },
  {
    ...
    description:
      "고압 상황의 타이브레이크 포인트에서 루틴과 의사결정을 훈련합니다.",
    icon: Brain,
    status: "완료",
    features: ["압박 모드", "스코어 상태", "루틴 설정", "메모 기록"],
    gradient: "from-violet-500 via-purple-500 to-fuchsia-500",
    bgColor: "bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50",
    iconBg: "bg-gradient-to-br from-violet-500 to-purple-500",
    category: "멘탈 훈련",
  },
  {
    ...
    title: "서브 배치 맵퍼",
    description: "스코어와 사이드에 따라 1st/2nd 서브 타겟 위치를 매핑합니다.",
    icon: Crosshair,
    status: "완료",
    features: ["타겟 존 설정", "듀스/애드 구분", "서브 계획", "내보내기"],
    gradient: "from-blue-500 via-cyan-500 to-teal-500",
    bgColor: "bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50",
    iconBg: "bg-gradient-to-br from-blue-500 to-cyan-500",
    category: "서브 분석",
  },
  {
    ...
    title: "리턴 포지션 계산기",
    description:
      "서브 속도와 코트 서피스에 따라 최적의 리턴 깊이를 계산합니다.",
    icon: Gauge,
    status: "완료",
    features: ["서브 속도 입력", "서피스 모드", "깊이 범위", "맞춤 팁"],
    gradient: "from-emerald-500 via-green-500 to-lime-500",
    bgColor: "bg-gradient-to-br from-emerald-50 via-green-50 to-lime-50",
    iconBg: "bg-gradient-to-br from-emerald-500 to-green-500",
    category: "리턴 분석",
  },
  {
    ...
    title: "경기일 준비물 체크리스트",
    description:
      "라켓, 의류, 수분 보충, 회복 장비 등 경기일 준비물을 체계적으로 관리합니다.",
    icon: CheckCircle,
    status: "완료",
    features: ["맞춤 리스트", "날씨별 프리셋", "알림 기능", "원정 모드"],
  ...
  },
  {
    ...
    title: "수분 보충 플래너",
    description:
      "날씨와 경기 시간에 따라 필요한 수분 및 전해질 섭취량을 계산합니다.",
    icon: Waves,
    status: "완료",
    features: ["수분 목표량", "고온 모드", "전해질 계산", "섭취 추적"],
  ...
  },
  {
    ...
    title: "수면 컨디션 체크",
    description: "경기 또는 강도 높은 훈련 전 수면 품질을 점검합니다.",
    icon: Moon,
    status: "완료",
    features: ["컨디션 점수", "수면 진단", "주의 사항", "개선 제안"],
  ...
  },
  {
    ...
    title: "회복 루틴 생성기",
    description:
      "경기 후 운동 부하와 신체 상태에 맞는 회복 루틴을 자동 생성합니다.",
    icon: Heart,
    status: "완료",
    features: ["부하 기반 계획", "모빌리티", "주의 사항", "시간 관리"],
  ...
  },
  {
    ...
    title: "워밍업 루틴 빌더",
    description: "경기 시간과 목표에 맞는 워밍업 시퀀스를 구성합니다.",
    icon: Flame,
    status: "완료",
    features: ["시간별 프리셋", "모빌리티", "활성화 운동", "코트 루틴"],
    gradient: "from-orange-500 via-red-500 to-pink-500",
    bgColor: "bg-gradient-to-br from-orange-50 via-red-50 to-pink-50",
    iconBg: "bg-gradient-to-br from-orange-500 to-red-500",
    category: "훈련 준비",
  },
  {
    ...
    title: "쿨다운 루틴 빌더",
    description: "경기 후 피로를 줄이기 위한 쿨다운 시퀀스를 구성합니다.",
    icon: Activity,
    status: "완료",
    features: ["스트레칭 메뉴", "회복 블록", "시간 계획", "다음 준비"],
  ...
  },
  {
    ...
    title: "연습 드릴 생성기",
    description:
      "일관성과 패턴 플레이를 위한 집중 훈련 세션을 자동 생성합니다.",
    icon: Sparkles,
    status: "완료",
    features: ["목표별 드릴", "단계별 진행", "파트너 모드", "템플릿"],
  ...
  },
  {
    ...
    title: "벽치기 훈련 플래너",
    description:
      "반복 횟수, 시간, 스트로크 포커스로 솔로 벽치기 훈련을 계획합니다.",
    icon: FileText,
    status: "완료",
    features: ["솔로 모드", "반복 목표", "스트로크 집중", "인터벌 설정"],
    gradient: "from-amber-500 via-yellow-500 to-orange-500",
    bgColor: "bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50",
    iconBg: "bg-gradient-to-br from-amber-500 to-yellow-500",
    category: "훈련 계획",
  },
  {
    ...
    title: "대회 예산 계산기",
    description: "교통, 숙박, 장비, 식비 등 대회 참가 비용을 예측합니다.",
    icon: Calculator,
    status: "완료",
    features: ["비용 항목별", "교통비 합산", "예산 한도", "비교 분석"],
    gradient: "from-green-500 via-emerald-500 to-teal-500",
    bgColor: "bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50",
    iconBg: "bg-gradient-to-br from-green-500 to-emerald-500",
    category: "경기 준비",
  },
  {
    ...
    icon: MapPin,
    status: "완료",
    features: ["서피스별 프리셋", "훈련 가이드", "장비 추천", "움직임 팁"],
    gradient: "from-lime-500 via-green-500 to-emerald-500",
    bgColor: "bg-gradient-to-br from-lime-50 via-green-50 to-emerald-50",
    iconBg: "bg-gradient-to-br from-lime-500 to-green-500",
    category: "전략 가이드",
  },
  {
    ...
    title: "랠리 일관성 트래커",
    description: "랠리 길이, 에러, 성공 추세를 기록하고 추적합니다.",
    icon: BarChart,
    status: "완료",
    features: ["랠리 카운트", "에러 기록", "추세 분석", "히스토리"],
  ...
  },
  {
    ...
    title: "비강제 에러 분석기",
    description: "스트로크, 코트 존, 스코어 상태별 에러 패턴을 분석합니다.",
    icon: AlertTriangle,
    status: "완료",
    features: ["에러 분류", "상황 태그", "패턴 발견", "개선 전략"],
  ...
  },
  {
    ...
    title: "경기 영상 리뷰 템플릿",
    description:
      "경기 영상 리뷰 시 전술과 의사결정 패턴을 체계적으로 기록합니다.",
    icon: Video,
    status: "완료",
    features: ["리뷰 가이드", "태그 분류", "메모 기록", "요약 정리"],
    gradient: "from-fuchsia-500 via-pink-500 to-rose-500",
    bgColor: "bg-gradient-to-br from-fuchsia-50 via-pink-50 to-rose-50",
    iconBg: "bg-gradient-to-br from-fuchsia-500 to-pink-500",
    category: "경기 분석",
  },
  {
    ...
    title: "목표 달성 스트릭 트래커",
    description: "훈련 주간별 습관과 단기 목표 달성을 추적합니다.",
    icon: Calendar,
    status: "완료",
    features: ["습관 스트릭", "주간 목표", "진행 현황", "알림 기능"],
    gradient: "from-violet-500 via-purple-500 to-indigo-500",
    bgColor: "bg-gradient-to-br from-violet-50 via-purple-50 to-indigo-50",
    iconBg: "bg-gradient-to-br from-violet-500 to-purple-500",
    category: "목표 관리",
  },
  {
    ...
    title: "장비 관리 스케줄러",
    description: "스트링 교체, 그립 교환, 신발 점검을 한곳에서 관리합니다.",
    icon: Settings2,
    status: "완료",
    features: ["교체 주기", "알림 설정", "사용 기록", "메모"],
    gradient: "from-slate-500 via-gray-500 to-zinc-500",
    bgColor: "bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-50",
    iconBg: "bg-gradient-to-br from-slate-500 to-gray-500",
    category: "장비 관리",
  },
  {
    ...
    title: "그립 사이즈 체커",
    description:
      "손 치수와 그립감 선호도를 기반으로 최적의 그립 사이즈를 추정합니다.",
    icon: Hand,
    status: "완료",
    features: ["손 측정", "핏 가이드", "편안함 평가", "맞춤 팁"],
    gradient: "from-cyan-500 via-blue-500 to-indigo-500",
    bgColor: "bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-50",
    iconBg: "bg-gradient-to-br from-cyan-500 to-blue-500",
    category: "장비 관리",
  },
  {
    ...
    title: "오버그립 교체 알림",
    description: "사용량과 환경 조건에 따라 오버그립 교체 시기를 알려줍니다.",
    icon: RotateCcw,
    status: "완료",
    features: ["사용량 알림", "습도 참고", "마모 추적", "교체 시기"],
  ...
  },
  {
    ...
    title: "스트링 교체 알림",
    description: "타구 횟수와 스트링 상태를 추적하여 교체 시기를 알려줍니다.",
    icon: Clock,
    status: "완료",
    features: ["타구 카운트", "텐션 메모", "알림 설정", "교체 이력"],
  ...
  },
  {
    ...
    title: "테니스화 마모 트래커",
    description:
      "아웃솔 마모와 지지력 저하를 모니터링하여 교체 시기를 판단합니다.",
    icon: Footprints,
    status: "완료",
    features: ["마모 표시", "거리 기록", "서피스 메모", "교체 안내"],
    gradient: "from-indigo-500 via-purple-500 to-pink-500",
    bgColor: "bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50",
    iconBg: "bg-gradient-to-br from-indigo-500 to-purple-500",
    category: "장비 관리",
  },
  {
    ...
    title: "복식 케미 테스트",
    description: "복식 파트너와의 소통 스타일과 역할 균형을 점검합니다.",
    icon: Users,
    status: "완료",
    features: ["파트너 테스트", "역할 적합도", "스타일 매칭", "점수 산출"],
    gradient: "from-pink-500 via-rose-500 to-red-500",
    bgColor: "bg-gradient-to-br from-pink-50 via-rose-50 to-red-50",
    iconBg: "bg-gradient-to-br from-pink-500 to-rose-500",
    category: "복식 전략",
  },
  {
    ...
    title: "파트너 궁합 체크",
    description: "파트너 간의 템포, 포지셔닝, 전술 성향을 비교 분석합니다.",
    icon: Heart,
    status: "완료",
    features: ["궁합 분석", "스타일 비교", "주의 사항", "맞춤 팁"],
    gradient: "from-rose-500 via-pink-500 to-fuchsia-500",
    bgColor: "bg-gradient-to-br from-rose-50 via-pink-50 to-fuchsia-50",
    iconBg: "bg-gradient-to-br from-rose-500 to-pink-500",
    category: "복식 전략",
  },
  {
    ...
    title: "주니어 성장 로드맵",
    description: "연령별 적합한 우선순위로 주니어 테니스 성장을 설계합니다.",
    icon: School,
    status: "완료",
    features: ["연령별 단계", "기술 포커스", "대회 준비", "성장 가이드"],
  ...
  },
  {
    ...
    title: "성인 입문자 로드맵",
    description:
      "테니스를 처음 시작하는 성인을 위한 첫 3개월 현실적 목표를 설정합니다.",
    icon: BookOpen,
    status: "완료",
    features: ["90일 플랜", "단계별 목표", "추천 드릴", "성취 목표"],
    gradient: "from-emerald-500 via-green-500 to-lime-500",
    bgColor: "bg-gradient-to-br from-emerald-50 via-green-50 to-lime-50",
    iconBg: "bg-gradient-to-br from-emerald-500 to-green-500",
    category: "입문 가이드",
  },
  {
    ...
    title: "테니스 시간 플래너",
    description:
      "직장, 출장, 회복 부하를 고려하여 주간 테니스 시간을 계획합니다.",
    icon: Clock,
    status: "완료",
    features: ["주간 계획", "부하 균형", "회복 슬롯", "한눈에 보기"],
  ...
  },
  {
    ...
    title: "원정 짐 싸기 플래너",
    description: "대회 원정이나 주말 경기를 위한 짐 싸기 리스트를 구성합니다.",
    icon: MapPin,
    status: "완료",
    features: ["여행 프리셋", "준비물 리스트", "날씨 반영", "알림 기능"],
...
export default function UtilityPage() {
  ...
  const plannedUtilities = utilitiesMetadata.filter(
    (u) => u.status === "개발 예정",
  );
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
      ...
      <div className="bg-court-ink text-white pt-24 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-accent-volt mb-4">
            Tennis Tools
          </p>
          <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight flex items-center justify-center gap-4">
            <span className="p-3 bg-white/10 rounded-sm border border-white/10">
              <Settings className="w-10 h-10 md:w-12 md:h-12 text-accent-volt" />
            </span>
            테니스 유틸리티
          </h1>
          <p className="text-xl text-white/60 max-w-2xl mx-auto font-light leading-relaxed">
            당신의 테니스 라이프를 더 스마트하게 만들어줄
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-10 relative z-20">
        ...
        <section className="mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <Badge className="bg-blue-600 ml-2 shadow-sm shadow-blue-500/30">
                  ...
                  <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden bg-white dark:bg-gray-800 ring-1 ring-gray-100 dark:ring-gray-700 hover:ring-2 hover:ring-blue-500 hover:-translate-y-1">
                    ...
                    <CardContent className="p-6">
                      <div className="flex justify-between items-start mb-4">
                        <div
                          className={`p-3 rounded-xl ${utility.bgColor} group-hover:scale-110 transition-transform duration-300 shadow-inner`}
                        >
                          <Icon
                            className={`w-8 h-8 ${utility.gradient.split(" ")[1].replace("via-", "text-")}`}
                          />
                        </div>
                        <Badge
                          variant="secondary"
        ...
        <section className="relative py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 opacity-75 hover:opacity-100 transition-opacity duration-300">
            {plannedUtilities.map((utility) => {
              ...
              return (
                <Card
                  key={utility.id}
                  className="border border-dashed border-gray-300 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/30 hover:bg-white dark:hover:bg-gray-800 transition-colors cursor-default"
                >
          ...
          <div className="mt-16 bg-gradient-to-r from-gray-900 to-blue-900 rounded-2xl p-8 md:p-12 text-center text-white shadow-2xl relative overflow-hidden">
            ...
            <p className="text-blue-200 mb-8 max-w-xl mx-auto relative z-10">
              테니스 프렌즈는 여러분의 의견으로 성장합니다.
              <br />
              필요한 계산기나 분석 도구가 있다면 언제든 알려주세요.
            </p>
            <Button
              size="lg"
              className="bg-white text-blue-900 hover:bg-blue-50 font-bold px-8 rounded-full relative z-10"
            >
              기능 제안하기
            </Button>
          </div>
