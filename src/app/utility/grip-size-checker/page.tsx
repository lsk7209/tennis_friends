...
export const metadata: Metadata = generatePageMetadata({
  title: "그립 사이즈 체커",
  description: "그립 사이즈 체커 utility for tennis players who want a clearer workflow and faster decisions.",
  path: "/utility/grip-size-checker",
  type: "website",
  tags: ["tennis utility", "Equipment", "그립 사이즈 체커"],
});
...
const sections = [
  {
    ...
    "body": "그립 사이즈 체커 is designed to turn a vague tennis problem into a clear next action. Instead of broad advice, it focuses on one decision area and gives the user a practical frame to work with."
  },
  {
    "id": "inputs",
    "heading": "Recommended Inputs",
    "body": "The most useful version of 그립 사이즈 체커 starts with realistic inputs: current level, recent playing volume, surface context, and the match or training goal. That keeps the output useful rather than generic."
  },
  {
    "id": "use-cases",
    "heading": "Best Use Cases",
    "body": "그립 사이즈 체커 is most valuable before training, before match play, or during weekly review. It works best when used as part of a repeatable process instead of a one-time check."
  },
  {
    "id": "next-step",
    "heading": "Next Step",
    "body": "After using 그립 사이즈 체커, the next step should be simple: update one plan, change one practice focus, or test one tactical decision. That is how a utility in the Equipment category creates measurable improvement."
  }
] as const;
    ...
    <main className="mx-auto w-full max-w-5xl px-4 py-12">
      <section className="rounded-3xl border border-black/5 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-gray-900">
        ...
        <p className="max-w-3xl text-base leading-7 text-gray-600 dark:text-gray-300">
          그립 사이즈 체커 is now available as part of the TennisFriends utility expansion set. This first version is structured to help users understand the workflow, expected inputs, and practical next actions.
        </p>
