...
export const PLAYERS_DB: Record<string, PlayerData> = {
    ...
    'dayana-yastremska': {
        ...
        longBio: '예선 통과자 신화의 주인공. 2024 호주 오픈에서 예선부터 시작해 4강까지 오르는 기적을 썼습니다. 언제 터질지 모르는 폭발적인 공격력을 가진 "닥공(닥치고 공격)"의 화신입니다.',
        detailedProfile: {
            oneLineSummary: '2024 호주 오픈 4강 신화, 우크라이나의 "공격 본능".',
            whyNotable: `
                <div class="highlight-box">
                    <div class="highlight-box-title">🇺🇦 "The Qualifier Miracle"</div>
                    <p>2024년 호주 오픈에서 예선 통과자(Qualifier) 최초로 4강에 진출하는 역사를 썼습니다. 전쟁 중인 조국 우크라이나에 희망을 전하며 전 세계 팬들에게 큰 울림을 주었습니다.</p>
                </div>
            `,
            playStyle: `
                <p><strong>"All or Nothing (닥공)"</strong></p>
                <p>수비는 생각하지 않습니다. 모든 공을 위너로 만들겠다는 기세로 때립니다.</p>
                <ul class="list-disc pl-5 my-4 space-y-2">
                    <li><strong>파워:</strong> 체구에 비해 엄청난 파워를 뿜어냅니다.</li>
                    <li><strong>리턴:</strong> 서브 리턴부터 바로 공격해 들어갑니다.</li>
                    <li><strong>기복:</strong> 잘 들어가는 날엔 누구도 못 막지만, 안 되는 날엔 에러가 쏟아집니다.</li>
                </ul>
            `,
            hexagonStats: [
                { name: '공격성 (Aggression)', score: 10, description: '타협 없음.' },
                { name: '파워 (Power)', score: 9, description: '폭발적.' },
                { name: '멘탈 (Mental)', score: 8, description: '전사.' },
                { name: '수비 (Defense)', score: 5, description: '약점.' },
                { name: '일관성 (Consistency)', score: 5, description: '기복 심함.' },
                { name: '서브 (Serve)', score: 7, description: '기복 있음.' }
            ],
            growthStory: `
                <p>오데사 출신으로 주니어 시절부터 세계 랭킹 6위에 오르며 유망주로 꼽혔습니다. 도핑 징계 등으로 힘든 시간을 보냈으나 2024년 화려하게 부활했습니다.</p>
            `,
            signatureMatch: {
                title: '2024 호주 오픈 8강 vs 린다 노스코바',
                date: '2024. 01. 24',
                description: '기적의 완성. 예선부터 치러 체력이 바닥난 상태에서도 정신력으로 버티며 생애 첫 메이저 4강을 확정 지었습니다.'
            },
            fanAppeal: `
                <div class="highlight-box">
                    <div class="highlight-box-title">🎤 "가수 데뷔?"</div>
                    <p>실제로 음원을 낸 적이 있을 정도로 노래와 춤을 좋아합니다. 코트 밖에서는 끼 넘치는 20대입니다.</p>
                </div>
            `,
            recentForm: `
                <p><strong>"Top 30 복귀"</strong></p>
                <p>호주 오픈 이후 랭킹을 크게 회복하여 투어급 대회 시드를 받고 있습니다.</p>
            `,
            faq: [
                {
                    question: '눈 밑 패치는 왜 붙이나요?',
                    answer: '조국 우크라이나 국기의 색깔 등 메시지를 담아 붙일 때가 많습니다.'
                }
            ]
        }
    },
    'anna-kalinskaya': {
        ...
        longBio: '차가운 포커페이스 뒤에 숨겨진 정교한 스트로크. 2024년 두바이 챔피언십 준우승을 차지하며 세계 랭킹 상위권으로 도약한 "얼음 공주"입니다.',
        detailedProfile: {
            oneLineSummary: '감정 없는 암살자, 차분하게 상대를 무너뜨리는 "Ice Princess".',
            whyNotable: `
                <div class="highlight-box">
                    <div class="highlight-box-title">❄️ "신데렐라 스토리"</div>
                    <p>2024년 두바이 챔피언십에서 세계 1위 시비옹테크, 3위 고프, 9위 오스타펜코를 연달아 격파하고 결승에 오르며 전 세계를 놀라게 했습니다.</p>
                </div>
            `,
            playStyle: `
                <p><strong>"플랫 히터 & 카운터 펀처"</strong></p>
                <p>감정을 드러내지 않고 기계처럼 정교하게 공을 칩니다. 공의 탄도가 낮고 빨라 상대가 타이밍을 맞추기 어렵습니다.</p>
                <ul class="list-disc pl-5 my-4 space-y-2">
                    <li><strong>백핸드:</strong> 매우 안정적이고 날카롭습니다.</li>
                    <li><strong>리턴:</strong> 공격적인 리턴으로 상대를 압박합니다.</li>
                    <li><strong>침착함:</strong> 어떤 상황에서도 표정 변화가 거의 없습니다.</li>
                </ul>
            `,
            hexagonStats: [
                { name: '멘탈 (Mental)', score: 9, description: '포커페이스.' },
                { name: '백핸드 (Backhand)', score: 9, description: '주무기.' },
                { name: '리턴 (Return)', score: 8.5, description: '날카로움.' },
                { name: '이동 (Movement)', score: 8, description: '효율적.' },
                { name: '파워 (Power)', score: 7.5, description: '타이밍 위주.' },
                { name: '서브 (Serve)', score: 7, description: '평범.' }
            ],
            growthStory: `
                <p>모스크바 출신으로 부모님이 모두 배드민턴 선수 출신입니다. 뛰어난 운동 유전자를 물려받았습니다.</p>
            `,
            signatureMatch: {
                title: '2024 두바이 4강 vs 이가 시비옹테크',
                date: '2024. 02. 23',
                description: '여제를 꺾다. 무패 행진을 달리던 시비옹테크를 2-0으로 완파하며 결승에 진출, 자신의 이름을 전 세계에 알렸습니다.'
            },
            fanAppeal: `
                <div class="highlight-box">
                    <div class="highlight-box-title">🐕 "애견인 & 미모"</div>
                    <p>빼어난 미모로 많은 팬을 보유하고 있으며, 반려견을 매우 사랑하여 투어에도 자주 데리고 다닙니다. 야닉 시너와의 연애설로도 화제가 되었습니다.</p>
                </div>
            `,
            recentForm: `
                <p><strong>"Career High"</strong></p>
                <p>2024년 들어 가장 좋은 성적을 내며 Top 20 진입에 성공했습니다.</p>
            `,
            faq: [
                {
                    question: '남자친구?',
                    answer: '2024년 5월, 이탈리아의 야닉 시너와 교제 중임을 공식 인정했습니다.'
                }
            ]
        }
    },
    'jasmine-paolini': {
        ...
        longBio: '163cm의 작은 키를 극복한 "작은 거인". 2024년 프랑스 오픈과 윔블던에서 연속으로 결승에 오르는 기염을 토하며 세계 랭킹 Top 5에 진입했습니다.',
        detailedProfile: {
            oneLineSummary: '2024년 최고의 신데렐라, 한계를 모르는 "이탈리아의 태양".',
            whyNotable: `
                <div class="highlight-box">
                    <div class="highlight-box-title">🌞 "Late Bloomer"</div>
                    <p>20대 후반에 전성기가 왔습니다. 2024년 두바이 우승, 프랑스 오픈 준우승, 윔블던 준우승이라는 믿기 힘든 성과를 거두며 세계 5위 안에 들었습니다. 작은 키는 숫자에 불과함을 증명했습니다.</p>
                </div>
            `,
            playStyle: `
                <p><strong>"스피디 & 어그레시브"</strong></p>
                <p>엄청난 활동량과 빠른 풋워크로 코트를 커버하고, 기회가 오면 주저 없이 포핸드 강타를 날립니다.</p>
                <ul class="list-disc pl-5 my-4 space-y-2">
                    <li><strong>포핸드:</strong> 작은 체구에서 나오는 스핀 많은 포핸드가 묵직합니다.</li>
                    <li><strong>풋워크:</strong> 투어에서 누구보다 빠릅니다.</li>
                    <li><strong>에너지:</strong> 항상 긍정적인 에너지를 뿜어냅니다.</li>
                </ul>
            `,
            hexagonStats: [
                { name: '이동 (Movement)', score: 10, description: '최상급 스피드.' },
                { name: '체력 (Stamina)', score: 10, description: '무한 동력.' },
                { name: '포핸드 (Forehand)', score: 9, description: '헤비 톱스핀.' },
                { name: '멘탈 (Mental)', score: 9.5, description: '긍정왕.' },
                { name: '서브 (Serve)', score: 6, description: '신체적 열세.' },
                { name: '네트 (Net)', score: 7, description: '복식 경험으로 준수.' }
            ],
            growthStory: `
                <p>토스카나 출신으로, 가나와 폴란드 혈통을 이어받았습니다. 오랜 기간 50-100위권에 머물렀으나, 끊임없는 노력으로 28세에 꽃을 피웠습니다.</p>
            `,
            signatureMatch: {
                title: '2024 윔블던 4강 vs 도나 베키치',
                date: '2024. 07. 11',
                description: '윔블던 역사상 최장 시간 여자 준결승(2시간 51분). 티브레이크 접전 끝에 승리하며 결승에 진출, 관중들의 기립박수를 받았습니다.'
            },
            fanAppeal: `
                <div class="highlight-box">
                    <div class="highlight-box-title">😊 "스마일 퀸"</div>
                    <p>항상 밝게 웃는 모습이 매력적입니다. 인터뷰할 때의 솔직하고 유쾌한 태도로 전 세계 팬들의 사랑을 받고 있습니다.</p>
                </div>
            `,
            recentForm: `
                <p><strong>"인생 시즌"</strong></p>
                <p>단식뿐만 아니라 복식에서도 그랜드슬램 결승에 오르는 등 최고의 한 해를 보내고 있습니다.</p>
            `,
            faq: [
                {
                    question: '키가 정말 작나요?',
                    answer: '프로필상 163cm로 투어 최단신 그룹에 속하지만, 코트 위 존재감은 거인입니다.'
                }
            ]
        }
    },
    'sorana-cirstea': {
        ...
        longBio: '루마니아의 베테랑 스타. 데뷔 초 "제2의 그라프"라 불릴 만큼 재능을 인정받았으며, 30대가 된 지금도 변함없는 공격력으로 상위 랭커들을 위협합니다.',
        detailedProfile: {
            oneLineSummary: '클래스는 영원하다, 꾸준함과 파워를 겸비한 "루마니아의 자존심".',
            whyNotable: `
                <div class="highlight-box">
                    <div class="highlight-box-title">🍷 "와인 같은 선수"</div>
                    <p>나이가 들수록 플레이가 더 노련해지고 있습니다. 2023년 마이애미 오픈 4강, US 오픈 8강 등 전성기에 버금가는 성적을 다시 내고 있습니다.</p>
                </div>
            `,
            playStyle: `
                <p><strong>"공격적 베이스라이너"</strong></p>
                <p>플랫성 구질로 빠르게 치는 스타일입니다. 랠리를 길게 가져가기보다 먼저 때려서 끝내는 것을 선호합니다.</p>
                <ul class="list-disc pl-5 my-4 space-y-2">
                    <li><strong>포핸드:</strong> 시원시원한 스윙에서 나오는 위너가 일품입니다.</li>
                    <li><strong>공격:</strong> 수비 상황에서도 언제든 역습을 노립니다.</li>
                </ul>
            `,
            hexagonStats: [
                { name: '공격성 (Aggression)', score: 9, description: '선제 타격.' },
                { name: '파워 (Power)', score: 8.5, description: '준수함.' },
                { name: '경험 (Experience)', score: 9.5, description: '투어 베테랑.' },
                { name: '멘탈 (Mental)', score: 7, description: '가끔 흔들림.' },
                { name: '이동 (Movement)', score: 7.5, description: '나쁘지 않음.' },
                { name: '서브 (Serve)', score: 7.5, description: '평균 이상.' }
            ],
            growthStory: `
                <p>부카레스트 출신으로, 10대 때 이미 투어 우승을 차지하며 주목받았습니다. 부상과 부진이 있었지만 포기하지 않고 롱런하고 있습니다.</p>
            `,
            signatureMatch: {
                title: '2023 US 오픈 32강 vs 엘레나 리바키나',
                date: '2023. 09. 02',
                description: '대이변. 강력한 우승 후보였던 리바키나를 상대로 3세트 접전 끝에 승리하며 베테랑의 저력을 보여주었습니다.'
            },
            fanAppeal: `
                <div class="highlight-box">
                    <div class="highlight-box-title">👗 "패션 & 미모"</div>
                    <p>화려한 외모와 패션 감각으로도 유명합니다. 여러 스포츠 브랜드의 모델로 활동했습니다.</p>
                </div>
            `,
            recentForm: `
                <p><strong>"제2의 전성기"</strong></p>
                <p>30대 중반의 나이에도 세계 랭킹 20-30위권을 유지하며 건재함을 과시하고 있습니다.</p>
            `,
            faq: [
                {
                    question: '친구?',
                    answer: "오스타펜코 등 투어 선수들과 두루두루 친하게 지내는 '인싸'입니다."
                }
            ]
        }
    },
    'anastasia-potapova': {
        ...
        longBio: '러시아의 차세대 파이터. 주니어 세계 1위 출신으로, 코트 위에서 감정을 숨기지 않는 열정적인 플레이와 강력한 파워가 돋보입니다.',
        detailedProfile: {
            oneLineSummary: '코트를 지배하는 열정, 러시아 테니스의 "Wild Card".',
            whyNotable: `
                <div class="highlight-box">
                    <div class="highlight-box-title">🔥 "Fire on Court"</div>
                    <p>경기 중 화끈한 세리머니와 파이팅으로 분위기를 주도합니다. 2016 윔블던 주니어 챔피언 출신으로 재능은 확실합니다.</p>
                </div>
            `,
            playStyle: `
                <p><strong>"어그레시브 베이스라이너"</strong></p>
                <p>힘으로 밀어붙이는 스타일입니다. 서브와 포핸드, 백핸드 모두 공격적입니다.</p>
            `,
            hexagonStats: [
                { name: '파워 (Power)', score: 8.5, description: '강력함.' },
                { name: '공격성 (Aggression)', score: 9, description: '매우 공격적.' },
                { name: '멘탈 (Mental)', score: 7, description: '감정 기복.' },
                { name: '이동 (Movement)', score: 8, description: '빠름.' },
                { name: '기술 (Technique)', score: 8, description: '기본기 탄탄.' },
                { name: '서브 (Serve)', score: 7.5, description: '좋은 편.' }
            ],
            growthStory: `
                <p>사라토프 출신입니다. 할머니가 농구 코치였을 정도로 운동 집안에서 자랐습니다.</p>
            `,
            signatureMatch: {
                title: '2023 린츠 우승',
                date: '2023. 02. 12',
                description: '두 번째 투어 타이틀. 결승에서 페트라 마르티치를 꺾고 우승하며 랭킹을 끌어올렸습니다.'
            },
            fanAppeal: `
                <div class="highlight-box">
                    <div class="highlight-box-title">💑 "테니스 커플"</div>
                    <p>남자 테니스 선수 알렉산더 셰브첸코와 결혼하여 화제가 되었습니다. 부부가 함께 투어를 다니며 서로를 응원합니다.</p>
                </div>
            `,
            recentForm: `
                <p><strong>"도약 중"</strong></p>
                <p>꾸준히 투어 상위권 진입을 노리고 있습니다. 기복을 줄이는 것이 과제입니다.</p>
            `,
            faq: [
                {
                    question: '결혼했나요?',
                    answer: '네, 2023년 12월 동료 선수 알렉산더 셰브첸코와 결혼했습니다.'
                }
            ]
        }
    },
    'ekaterina-alexandrova': {
        ...
        longBio: '서울이 사랑한 선수(코리아 오픈 우승). 예측하기 힘든 템포와 낮게 깔리는 미사일 스트로크로 상대를 무력화시키는 "실내 코트의 강자"입니다.',
        detailedProfile: {
            oneLineSummary: '코리아 오픈의 여왕, 낮고 빠른 "미사일 샷"의 소유자.',
            whyNotable: `
                <div class="highlight-box">
                    <div class="highlight-box-title">🇰🇷 "Korea Lover"</div>
                    <p>WTA 코리아 오픈에서 유독 강한 모습을 보여 한국 팬들에게 인기가 많습니다. 2022년 우승, 2023년 준우승을 차지했습니다.</p>
                </div>
            `,
            playStyle: `
                <p><strong>"플랫 히터 (Flat Hitter)"</strong></p>
                <p>공 회전이 거의 없는 플랫 샷을 때립니다. 공이 바운드 후 낮게 깔리며 미끄러져 나가기 때문에 상대가 받기 매우 까다롭습니다. 특히 실내 코트나 잔디 코트에서 강합니다.</p>
            `,
            hexagonStats: [
                { name: '서브 (Serve)', score: 9, description: '에이스 많음.' },
                { name: '파워 (Power)', score: 9, description: '강력한 플랫.' },
                { name: '이동 (Movement)', score: 7.5, description: '준수.' },
                { name: '멘탈 (Mental)', score: 7, description: '조용함.' },
                { name: '일관성 (Consistency)', score: 7, description: '컨디션 탐.' },
                { name: '리턴 (Return)', score: 8.5, description: '공격적.' }
            ],
            growthStory: `
                <p>첼랴빈스크 출신이지만 오랜 기간 체코 프라하에서 거주하며 훈련했습니다. 그래서인지 동유럽 스타일의 깔끔한 테니스를 구사합니다.</p>
            `,
            signatureMatch: {
                title: '2024 마이애미 오픈 4강',
                date: '2024. 03. 28',
                description: '마스터스 4강 진출. 세계 1위 시비옹테크와 5위 페굴라를 연파하며 "자이언트 킬러"의 면모를 보여주었습니다.'
            },
            fanAppeal: `
                <div class="highlight-box">
                    <div class="highlight-box-title">😐 "시크함"</div>
                    <p>감정을 거의 드러내지 않는 시크한 매력이 있습니다. 하지만 승리 후 수줍게 웃는 모습이 반전 매력입니다.</p>
                </div>
            `,
            recentForm: `
                <p><strong>"High Level"</strong></p>
                <p>세계 랭킹 15-20위권을 오가며 꾸준히 활약 중입니다. 강자들을 잡는 조커 역할을 톡톡히 합니다.</p>
            `,
            faq: [
                {
                    question: '한국을 좋아하나요?',
                    answer: '네, 인터뷰에서 항상 한국 대회와 팬들에 대한 애정을 표현합니다. 음식도 좋아한다고 합니다.'
                }
            ]
        }
    },
    'liudmila-samsonova': {
        ...
        longBio: '이탈리아에서 자란 러시아의 파워 히터. 강력한 서브와 포핸드 "원투 펀치"를 앞세워 하드 코트에서 특히 강한 면모를 보입니다.',
        detailedProfile: {
            oneLineSummary: '이탈리안 감성의 러시아 파워, 폭발적인 "붐붐 테니스".',
            whyNotable: `
                <div class="highlight-box">
                    <div class="highlight-box-title">🔨 "Sledgehammer"</div>
                    <p>공을 부서져라 때립니다. WTA 투어에서 가장 강력한 서브와 포핸드를 가진 선수 중 한 명입니다. 한 번 흐름을 타면 연승을 달리는 몰아치기에 능합니다.</p>
                </div>
            `,
            playStyle: `
                <p><strong>"빅 서버 & 빅 포핸드"</strong></p>
                <p>전형적인 파워 테니스입니다. 서브로 득점하거나, 리턴이 짧게 오면 포핸드로 끝냅니다.</p>
            `,
            hexagonStats: [
                { name: '파워 (Power)', score: 9.5, description: '최상급.' },
                { name: '서브 (Serve)', score: 9.5, description: '주무기.' },
                { name: '포핸드 (Forehand)', score: 9.5, description: '위닝샷 제조기.' },
                { name: '이동 (Movement)', score: 7, description: '평범.' },
                { name: '멘탈 (Mental)', score: 7, description: '기복 있음.' },
                { name: '네트 (Net)', score: 6.5, description: '빈도 낮음.' }
            ],
            growthStory: `
                <p>러시아에서 태어났지만 어릴 때 이탈리아로 이주하여 성장했습니다. 한때 이탈리아 국적 취득을 고려하기도 했으나 러시아 대표로 뛰고 있습니다.</p>
            `,
            signatureMatch: {
                title: '2023 몬트리올 결승 진출',
                date: '2023. 08. 13',
                description: '마스터스 결승. 사발렌카, 리바키나 등 톱 랭커들을 꺾고 결승에 올랐으나 페굴라에게 아쉽게 패했습니다. 하지만 그녀의 파괴력을 증명한 대회였습니다.'
            },
            fanAppeal: `
                <div class="highlight-box">
                    <div class="highlight-box-title">🐶 "반려견 사랑"</div>
                    <p>SNS에 반려견 사진을 자주 올리는 평범한 20대 소녀의 감성을 가졌습니다.</p>
                </div>
            `,
            recentForm: `
                <p><strong>"우승 후보"</strong></p>
                <p>하드 코트 대회에서는 언제나 우승 후보로 거론됩니다. 메이저 대회에서의 성적이 조금 아쉽지만 잠재력은 충분합니다.</p>
            `,
            faq: [
                {
                    question: '이탈리아어?',
                    answer: '이탈리아에서 자라 원어민 수준으로 구사합니다.'
                }
            ]
        }
    }
