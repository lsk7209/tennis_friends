...
export const PLAYERS_DB: Record<string, PlayerData> = {
    ...
    // --- WTA Players ---
    'iga-swiatek': {
        name: '이가 스비옹텍', nameEn: 'Iga Swiatek', country: 'Poland', countryFlag: '🇵🇱', image: '/images/players/iga-swiatek.png', gender: 'female',
        plays: 'Right-handed', backhand: 'Two-handed',
        longBio: '폴란드 역사상 최초의 그랜드슬램 단식 우승자이자 세계 랭킹 1위. 압도적인 클레이 코트 실력으로 "클레이 여제"라 불리며, 남자 선수 못지않은 강력한 탑스핀 포핸드를 구사합니다.',
        detailedProfile: {
            oneLineSummary: '나달의 DNA를 가진 "클레이 여제". 베이글(6-0) 스코어를 가장 많이 만드는 압도적 지배력.',
            whyNotable: `
                <div class="highlight-box">
            ...
            `,
            hexagonStats: [
                { name: '포핸드 (Forehand)', score: 10, description: '여자 테니스 최고의 회전량과 파워.' },
                { name: '멘탈 (Mental)', score: 9.5, description: '스포츠 심리학자와 항상 동행하며 강철 멘탈 유지.' },
                { name: '풋워크 (Footwork)', score: 10, description: '코트 커버리지와 슬라이딩 능력이 독보적.' },
                { name: '리턴 (Return)', score: 9.5, description: '상대의 서브를 공격적으로 받아치는 능력이 탁월.' },
                { name: '백핸드 (Backhand)', score: 9, description: '안정적이고 견고한 투핸드 백핸드.' },
                { name: '서브 (Serve)', score: 8, description: '파워보다는 킥 서브와 코스 공략 위주.' }
            ],
            growthStory: `
            ...
            signatureMatch: {
                ...
                date: '2020. 10. 10',
                description: '전설의 시작. 당시 세계 랭킹 54위였던 19세 소녀 스비옹텍이 호주 오픈 챔피언 케닌을 6-4, 6-1로 압도하며 생애 첫 그랜드슬램 트로피를 들어 올린 경기입니다.'
            },
            fanAppeal: `
                <div class="highlight-box">
            ...
            faq: [
                {
                    ...
                    answer: '테니스에서 6-0 스코어를 "베이글(Bagel)", 6-1 스코어를 "브레드스틱(Breadstick)"이라고 부릅니다. 스비옹텍은 압도적인 실력으로 상대를 6-0이나 6-1로 이기는 경우가 많아, 팬들이 "스비옹텍이 베이커리를 열었다"라고 농담하며 붙여준 별명입니다.'
                },
                {
                    question: '스비옹텍이 경기 중에 모자를 푹 눌러쓰는 이유는?',
                    answer: '그녀는 경기에 집중하기 위해 시야를 제한하고 싶어 합니다. 챙이 넓은 모자를 푹 눌러써서 관중석이나 다른 방해 요소를 차단하고, 오직 공과 코트에만 집중하는 그녀만의 루틴입니다.'
                },
                {
                    question: '스비옹텍의 우상은 누구인가요?',
                    answer: '그녀의 우상은 "클레이의 황제" 라파엘 나달입니다. 스비옹텍의 플레이 스타일(강력한 탑스핀, 끈질긴 수비, 왼손잡이 같은 포핸드 모션 등)은 나달에게 많은 영감을 받았습니다. 실제로 나달의 경기를 보며 자랐고, 성덕(성공한 덕후)이 되어 나달과 함께 훈련하기도 했습니다.'
                }
            ]
        }
    },
    ...
    'kei-nishikori': {
        name: '니시코리 케이', nameEn: 'Kei Nishikori', country: 'Japan', countryFlag: '🇯🇵', image: '/images/players/kei-nishikori.png', gender: 'male',
        plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'christopher-eubanks': {
        name: '크리스토퍼 유뱅크스', nameEn: 'Christopher Eubanks', country: 'United States', countryFlag: '🇺🇸', image: '/images/players/christopher-eubanks.png', gender: 'male', plays: 'Right-handed', backhand: 'One-handed',
    ...
    'emil-ruusuvuori': {
        name: '에밀 루수부오리', nameEn: 'Emil Ruusuvuori', country: 'Finland', countryFlag: '🇫🇮', image: '/images/players/emil-ruusuvuori.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'miomir-kecmanovic': {
        name: '미오미르 케크마노비치', nameEn: 'Miomir Kecmanovic', country: 'Serbia', countryFlag: '🇷🇸', image: '/images/players/miomir-kecmanovic.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'roman-safiullin': {
        name: '로만 사피울린', nameEn: 'Roman Safiullin', country: 'Russia', countryFlag: '🇷🇺', image: '/images/players/roman-safiullin.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'laslo-djere': {
        name: '라슬로 제레', nameEn: 'Laslo Djere', country: 'Serbia', countryFlag: '🇷🇸', image: '/images/players/laslo-djere.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'daniel-evans': {
        name: '다니엘 에반스', nameEn: 'Daniel Evans', country: 'United Kingdom', countryFlag: '🇬🇧', image: '/images/players/daniel-evans.png', gender: 'male', plays: 'Right-handed', backhand: 'One-handed',
    ...
    'roberto-carballes-baena': {
        name: '로베르토 카르바예스 바에나', nameEn: 'Roberto Carballes Baena', country: 'Spain', countryFlag: '🇪🇸', image: '/images/players/roberto-carballes-baena.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'nuno-borges': {
        name: '누노 보르헤스', nameEn: 'Nuno Borges', country: 'Portugal', countryFlag: '🇵🇹', image: '/images/players/nuno-borges.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'mackenzie-mcdonald': {
        name: '매켄지 맥도날드', nameEn: 'Mackenzie McDonald', country: 'United States', countryFlag: '🇺🇸', image: '/images/players/mackenzie-mcdonald.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'max-purcell': {
        name: '맥스 퍼셀', nameEn: 'Max Purcell', country: 'Australia', countryFlag: '🇦🇺', image: '/images/players/max-purcell.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'dominik-koepfer': {
        name: '도미닉 쾨퍼', nameEn: 'Dominik Koepfer', country: 'Germany', countryFlag: '🇩🇪', image: '/images/players/dominik-koepfer.png', gender: 'male', plays: 'Left-handed', backhand: 'Two-handed',
    ...
    'aleksandar-vukic': {
        name: '알렉산더 부키치', nameEn: 'Aleksandar Vukic', country: 'Australia', countryFlag: '🇦🇺', image: '/images/players/aleksandar-vukic.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'yoshihito-nishioka': {
        name: '요시히토 니시오카', nameEn: 'Yoshihito Nishioka', country: 'Japan', countryFlag: '🇯🇵', image: '/images/players/yoshihito-nishioka.png', gender: 'male', plays: 'Left-handed', backhand: 'Two-handed',
    ...
    'alexander-shevchenko': {
        name: '알렉산더 셰브첸코', nameEn: 'Alexander Shevchenko', country: 'Kazakhstan', countryFlag: '🇰🇿', image: '/images/players/alexander-shevchenko.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'rinky-hijikata': {
        name: '린키 히지카타', nameEn: 'Rinky Hijikata', country: 'Australia', countryFlag: '🇦🇺', image: '/images/players/rinky-hijikata.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'botic-van-de-zandschulp': {
        name: '보틱 반 더 잔츠슐프', nameEn: 'Botic van de Zandschulp', country: 'Netherlands', countryFlag: '🇳🇱', image: '/images/players/botic-van-de-zandschulp.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'yannick-hanfmann': {
        name: '야닉 한프만', nameEn: 'Yannick Hanfmann', country: 'Germany', countryFlag: '🇩🇪', image: '/images/players/yannick-hanfmann.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'pavel-kotov': {
        name: '파벨 코토프', nameEn: 'Pavel Kotov', country: 'Russia', countryFlag: '🇷🇺', image: '/images/players/pavel-kotov.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'aslan-karatsev': {
        name: '아슬란 카라체프', nameEn: 'Aslan Karatsev', country: 'Russia', countryFlag: '🇷🇺', image: '/images/players/aslan-karatsev.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'fabian-marozsan': {
        image: '/images/players/fabian-marozsan.png',
    ...
    'sumit-nagal': {
        image: '/images/players/sumit-nagal.png',
    ...
    'taro-daniel': {
        image: '/images/players/taro-daniel.png',
    ...
    'roberto-bautista-agut': {
        image: '/images/players/roberto-bautista-agut.png',
    ...
    'marton-fucsovics': {
        image: '/images/players/marton-fucsovics.png',
    ...
    'borna-coric': {
        image: '/images/players/borna-coric.png',
    ...
    'gael-monfils': {
        name: '가엘 몽피스', nameEn: 'Gael Monfils', country: 'France', countryFlag: '🇫🇷', image: '/images/players/gael-monfils.png', gender: 'male',
        plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'matteo-berrettini': {
        name: '마테오 베레티니', nameEn: 'Matteo Berrettini', country: 'Italy', countryFlag: '🇮🇹', image: '/images/players/matteo-berrettini.png', gender: 'male',
        plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'felix-auger-aliassime': {
        image: '/images/players/felix-auger-aliassime.png',
    ...
    'denis-shapovalov': {
        image: '/images/players/denis-shapovalov.png',
    ...
    'alexander-bublik': {
        image: '/images/players/alexander-bublik.png',
    ...
    'jack-draper': {
        image: '/images/players/jack-draper.png',
    ...
    'arthur-fils': {
        name: '아서 필스', nameEn: 'Arthur Fils', country: 'France', countryFlag: '🇫🇷', image: '/images/players/arthur-fils.png', gender: 'male',
        plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'shang-juncheng': {
        name: '상 쥔청', nameEn: 'Shang Juncheng', country: 'China', countryFlag: '🇨🇳', image: '/images/players/shang-juncheng.png', gender: 'male', plays: 'Left-handed', backhand: 'Two-handed',
    ...
    'duje-ajdukovic': {
        name: '두예 아이두코비치', nameEn: 'Duje Ajdukovic', country: 'Croatia', countryFlag: '🇭🇷', image: '/images/players/duje-ajdukovic.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'dominic-thiem': {
        name: '도미니크 팀', nameEn: 'Dominic Thiem', country: 'Austria', countryFlag: '🇦🇹', image: '/images/players/dominic-thiem.png', gender: 'male', plays: 'Right-handed', backhand: 'One-handed',
    ...
    'fabio-fognini': {
        name: '파비오 포니니', nameEn: 'Fabio Fognini', country: 'Italy', countryFlag: '🇮🇹', image: '/images/players/fabio-fognini.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'reilly-opelka': {
        name: '라일리 오펠카', nameEn: 'Reilly Opelka', country: 'United States', countryFlag: '🇺🇸', image: '/images/players/reilly-opelka.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'marin-cilic': {
        name: '마린 칠리치', nameEn: 'Marin Cilic', country: 'Croatia', countryFlag: '🇭🇷', image: '/images/players/marin-cilic.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'milos-raonic': {
        name: '밀로스 라오니치', nameEn: 'Milos Raonic', country: 'Canada', countryFlag: '🇨🇦', image: '/images/players/milos-raonic.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'nick-kyrgios': {
        name: '닉 키리오스', nameEn: 'Nick Kyrgios', country: 'Australia', countryFlag: '🇦🇺', image: '/images/players/nick-kyrgios.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'richard-gasquet': {
        name: '리샤르 가스케', nameEn: 'Richard Gasquet', country: 'France', countryFlag: '🇫🇷', image: '/images/players/richard-gasquet.png', gender: 'male', plays: 'Right-handed', backhand: 'One-handed',
    ...
    'diego-schwartzman': {
        name: '디에고 슈와르츠만', nameEn: 'Diego Schwartzman', country: 'Argentina', countryFlag: '🇦🇷', image: '/images/players/diego-schwartzman.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'david-goffin': {
        name: '다비드 고핀', nameEn: 'David Goffin', country: 'Belgium', countryFlag: '🇧🇪', image: '/images/players/david-goffin.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'thanasi-kokkinakis': {
        name: '타나시 코키나키스', nameEn: 'Thanasi Kokkinakis', country: 'Australia', countryFlag: '🇦🇺', image: '/images/players/thanasi-kokkinakis.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'hugo-gaston': {
        name: '위고 가스통', nameEn: 'Hugo Gaston', country: 'France', countryFlag: '🇫🇷', image: '/images/players/hugo-gaston.png', gender: 'male', plays: 'Left-handed', backhand: 'Two-handed',
    ...
    'luca-nardi': {
        name: '루카 나르디', nameEn: 'Luca Nardi', country: 'Italy', countryFlag: '🇮🇹', image: '/images/players/luca-nardi.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'dino-prizmic': {
        name: '디노 프리즈미치', nameEn: 'Dino Prizmic', country: 'Croatia', countryFlag: '🇭🇷', image: '/images/players/dino-prizmic.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'coleman-wong': {
        name: '콜먼 웡', nameEn: 'Coleman Wong', country: 'Hong Kong', countryFlag: '🇭🇰', image: '/images/players/coleman-wong.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'ashleigh-barty': {
        name: '애슐리 바티', nameEn: 'Ashleigh Barty', country: 'Australia', countryFlag: '🇦🇺', image: '/images/players/ashleigh-barty.png', gender: 'female', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'simona-halep': {
        name: '시모나 할렙', nameEn: 'Simona Halep', country: 'Romania', countryFlag: '🇷🇴', image: '/images/players/simona-halep.png', gender: 'female', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'martina-hingis': {
        name: '마르티나 힝기스', nameEn: 'Martina Hingis', country: 'Switzerland', countryFlag: '🇨🇭', image: '/images/players/martina-hingis.png', gender: 'female', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'kim-clijsters': {
        name: '킴 클리스터스', nameEn: 'Kim Clijsters', country: 'Belgium', countryFlag: '🇧🇪', image: '/images/players/kim-clijsters.png', gender: 'female', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    'andy-roddick': {
        name: '앤디 로딕', nameEn: 'Andy Roddick', country: 'United States', countryFlag: '🇺🇸', image: '/images/players/andy-roddick.png', gender: 'male', plays: 'Right-handed', backhand: 'Two-handed',
    ...
    // --- Legends ---
    'roger-federer': {
        name: '로저 페더러', nameEn: 'Roger Federer', country: 'Switzerland', countryFlag: '🇨🇭', image: '/images/players/roger-federer.png', gender: 'male',
        plays: 'Right-handed', backhand: 'One-handed',
        longBio: '테니스 역사상 가장 우아하고 완벽한 선수. 20개의 그랜드슬램 타이틀과 310주 세계 랭킹 1위 기록을 보유한 "테니스의 황제"입니다. 코트 위에서의 움직임은 마치 발레를 보는 듯하며, 테니스를 단순한 스포츠를 넘어 예술의 경지로 끌어올렸다는 평가를 받습니다.',
        detailedProfile: {
            oneLineSummary: '숫자로 정의할 수 없는 위대함, 테니스를 예술로 승화시킨 영원한 황제.',
            whyNotable: `
                <div class="highlight-box">
                    <div class="highlight-box-title">👑 The GOAT Debate</div>
                    <p>그랜드슬램 20회 우승(윔블던 8회), ATP 투어 103회 우승, 310주 세계 1위(연속 237주 1위). 모든 기록의 시발점이자, 조코비치와 나달이 등장하기 전까지 테니스계의 절대지존이었습니다. 단순히 이기는 것뿐만 아니라, "어떻게 이기는가"에 대한 미학적 기준을 제시했습니다.</p>
                </div>
                <p>그의 플레이는 "액체 채찍(Liquid Whip)" 같은 포핸드와 우아한 원핸드 백핸드로 대표되며, 땀 한 방울 흘리지 않는 듯한 침착함(Cool)은 그의 트레이드마크입니다.</p>
            `,
            playStyle: `
                <p><strong>"공격적 올라운더 (Aggressive All-Rounder)"</strong></p>
                <p>페더러는 코트의 모든 영역을 지배합니다. 베이스라인에서의 강력한 스트로크, 환상적인 넷 플레이, 그리고 상대를 속이는 다양한 구질의 서브까지 모든 기술이 완벽합니다. 특히 공이 바운드되자마자 쳐내는 '라이징 샷' 템포는 상대를 질식하게 만듭니다.</p>
                <div class="highlight-box">
                    <div class="highlight-box-title">🩰 발레리나 풋워크</div>
                    <p>페더러의 가장 큰 무기는 소리 없이 움직이는 발놀림입니다. 코트 위를 떠다니는 듯한 그의 풋워크는 부상을 방지하고 40세까지 롱런할 수 있었던 비결입니다. 서브 앤 발리는 그의 클래식한 매력을 보여주는 주무기입니다.</p>
                </div>
            `,
            hexagonStats: [
                { name: '포핸드 (Forehand)', score: 10, description: '역대 최고의 포핸드 중 하나. "Liquid Whip"이라 불리는 유연함.' },
                { name: '서브 (Serve)', score: 10, description: '속도보다 코스와 회전으로 에이스를 만들어내는 정밀도.' },
                { name: '발리 (Volley)', score: 10, description: '현대 테니스에서 가장 완벽한 터치와 넷 플레이.' },
                { name: '백핸드 (Backhand)', score: 9, description: '우아한 원핸드. 높은 공에 약점이 있었으나 네오 백핸드로 극복.' },
                { name: '풋워크 (Footwork)', score: 10, description: '소리 없이 움직이는, 가장 효율적이고 우아한 스텝.' },
                { name: '천재성 (Genius)', score: 10, description: '상대의 예측을 벗어나는 창의적인 샷 메이킹.' }
            ],
            growthStory: `
                <p>어릴 적 페더러는 라켓을 던지고 심판에게 항의하는 '다혈질 소년'이었습니다. 하지만 피터 카터 코치의 죽음을 계기로 마음을 다잡고, 냉철한 마인드 컨트롤을 익히며 '무결점 황제'로 거듭났습니다.</p>
                <blockquote>
                    "내 전성기는 아직 오지 않았다." (2017년 호주 오픈 우승 후)
                </blockquote>
                <p>2016년 무릎 부상으로 시즌 아웃되었으나, 2017년 36세의 나이로 화려하게 복귀하여 호주 오픈과 윔블던을 제패하는 기적을 썼습니다.</p>
            `,
            signatureMatch: {
                title: '2017 호주 오픈 결승 vs 라파엘 나달',
                date: '2017. 01. 29',
                description: '세기의 라이벌전(Fedal)이자 페더러 최고의 명경기. 5세트 1-3으로 뒤지던 상황에서 "네오 백핸드"를 앞세워 5게임을 연속으로 따내며 6-3 대역전승을 거뒀습니다. 그의 18번째 그랜드슬램이자 진정한 부활을 알린 경기입니다.'
            },
            fanAppeal: `
                <div class="highlight-box">
                    <div class="highlight-box-title">🇨🇭 PeRFection</div>
                    <p>그의 이름(Roger Federer)의 이니셜을 딴 'R'과 'F' 로고는 테니스계의 가장 상징적인 브랜드입니다. 유니클로, 롤렉스, 벤츠 등 글로벌 브랜드들이 가장 사랑하는 스포츠 스타이자, 전 세계 어디를 가도 홈 경기 같은 응원을 받는 '테니스 그 자체'입니다.</p>
                </div>
            `,
            recentForm: `
                <p><strong>"Thank you, Roger"</strong></p>
                <p>2022년 레이버 컵을 끝으로 현역에서 은퇴했습니다. 마지막 경기에서 라이벌이자 친구인 나달과 복식 조를 이뤄 뛰며 전 세계 팬들에게 감동적인 작별 인사를 전했습니다. 현재는 재단 활동과 비즈니스에 집중하며 제2의 인생을 살고 있습니다.</p>
            `,
            faq: [
                {
                    question: '페더러가 테니스 황제로 불리는 이유는?',
                    answer: '단순히 승수 때문이 아니라, 테니스라는 종목의 품격을 높였기 때문입니다. 그의 우아한 플레이 스타일, 매너, 그리고 스타성은 테니스를 전 세계적인 인기 스포츠로 만드는 데 결정적인 역할을 했습니다.'
                },
                {
                    question: '페더러의 라이벌은 누구인가요?',
                    answer: '최대의 라이벌은 라파엘 나달입니다. "페달(Fedal)" 라이벌리는 스포츠 역사상 가장 위대한 라이벌 관계 중 하나로 꼽힙니다. 이후 노박 조코비치와 함께 "Big 3"를 형성하며 테니스 황금기를 이끌었습니다.'
                }
            ]
        }
    },
    'hyeon-chung': {
        name: '정현', nameEn: 'Hyeon Chung', country: 'South Korea', countryFlag: '🇰🇷', image: '/images/players/hyeon-chung.png', gender: 'male',
        plays: 'Right-handed', backhand: 'Two-handed',
        longBio: '한국 테니스 역사상 최초로 그랜드슬램 4강(2018 호주 오픈)에 진출하며 신드롬을 일으킨 "교수님". 강력한 백핸드와 끈질긴 수비력으로 노박 조코비치를 꺾으며 "자이언트 킬러"라는 별명을 얻었습니다.',
        detailedProfile: {
            oneLineSummary: '한국 테니스의 새 역사를 쓴 "자이언트 킬러", 2018 호주 오픈 4강의 기적.',
            whyNotable: `
                <div class="highlight-box">
                    <div class="highlight-box-title">🇰🇷 최초의 그랜드슬램 4강</div>
                    <p>2018년 호주 오픈에서 알렉산더 즈베레프(당시 4위)와 노박 조코비치(당시 전 1위)를 연달아 격파하며 4강에 오르는 파란을 일으켰습니다. 이는 한국 테니스 역사상 최고의 성적으로 남아있습니다.</p>
                </div>
                <p>특유의 흰 안경을 쓴 모습 때문에 "교수님(The Professor)"이라는 별명으로 불리며, 2017년 초대 ATP 넥스트 제너레이션 파이널스에서 우승하며 차세대 스타로 주목받았습니다.</p>
            `,
            playStyle: `
                <p><strong>"결점을 찾기 힘든 완벽한 방패 (The Iron Wall)"</strong></p>
                <p>전성기 시절 정현의 수비력은 "조코비치의 거울" 같다는 평가를 받았습니다. 코트 양옆으로 빠지는 공을 다리는 찢어가며(Sliding) 받아내는 유연성이 일품입니다. 수비 후 빈틈을 노려 치는 백핸드 다운더라인은 그의 가장 강력한 무기입니다.</p>
            `,
            hexagonStats: [
                { name: '백핸드 (Backhand)', score: 10, description: '투어 최정상급의 정확도와 파워를 겸비한 주무기.' },
                { name: '수비 (Defense)', score: 10, description: '조코비치를 연상시키는, 미친듯한 코트 커버리지.' },
                { name: '멘탈 (Mental)', score: 9, description: '어떤 상황에서도 표정 변화가 없는 포커페이스.' },
                { name: '체력 (Stamina)', score: 9, description: '5세트 접전에서도 지치지 않는 강인한 체력.' },
                { name: '포핸드 (Forehand)', score: 8, description: '백핸드에 비해 상대적으로 평범하지만 견고함.' },
                { name: '서브 (Serve)', score: 7.5, description: '가장 큰 약점으로 꼽히며, 부상 이후 폼 교정 중.' }
            ],
            growthStory: `
                <p>어릴 적 심한 약시를 교정하기 위해 초록색을 많이 보라는 의사의 권유로 테니스를 시작했습니다. 이 때문에 경기 중 항상 고글을 착용합니다.</p>
                <p>주니어 시절 윔블던 준우승을 차지하며 두각을 나타냈고, 2018년 호주 오픈에서의 활약으로 '정현 신드롬'을 일으키며 테니스를 한국의 인기 스포츠 반열에 올렸습니다.</p>
            `,
            signatureMatch: {
                title: '2018 호주 오픈 16강 vs 노박 조코비치',
                date: '2018. 01. 22',
                description: '전 세계를 경악시킨 경기. 자신의 우상인 조코비치를 상대로 한 치의 물러섬 없는 스트로크 대결을 펼친 끝에 3-0(7-6, 7-5, 7-6) 셧아웃 승리를 거뒀습니다. 조코비치조차 "마치 벽과 경기하는 것 같았다"며 극찬했습니다.'
            },
            fanAppeal: `
                <div class="highlight-box">
                    <div class="highlight-box-title">🎤 "We are on fire!"</div>
                    <p>호주 오픈 승리 후 인터뷰에서 서툰 영어로 "We are on fire!"라고 외치며 좌중을 휘어잡는 모습은 그의 겸손하면서도 유쾌한 매력을 보여주었습니다.</p>
                </div>
            `,
            recentForm: `
                <p><strong>"부상과의 긴 싸움, 그리고 재도전"</strong></p>
                <p>2018년 이후 허리와 다리 부상으로 오랜 기간 투어에서 이탈했습니다. 하지만 포기하지 않고 재활에 매진하며 챌린저 대회와 복식 경기에 출전하는 등 코트 복귀를 위해 끊임없이 노력하고 있습니다.</p>
            `,
            faq: [
                {
                    question: '정현 선수는 은퇴했나요?',
                    answer: '아니요, 아직 공식적으로 은퇴하지 않았습니다. 부상 치료와 재활을 병행하며 복귀를 준비하고 있습니다.'
                },
                {
                    question: '왜 경기 때 안경을 쓰나요?',
                    answer: '고도 난시와 약시가 있어 시력 교정을 위해 특수 제작된 스포츠 고글을 착용합니다. 이것이 그의 트레이드마크가 되어 "교수님"이라는 별명을 얻게 되었습니다.'
                }
            ]
        }
    },
    'lorenzo-sonego': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>로렌초 소네고는 빠른 코트에서 분위기를 끌어올리는 경기 운영으로 존재감을 드러낸다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>로렌초 소네고의 플레이는 에너지 넘치는 공격 전개와 빠른 템포를 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>로렌초 소네고는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 8.4, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 8.5, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.8, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 8.0, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.4, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 8.1, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>감정 표현이 풍부하고 흐름을 타면 코트 전체 에너지를 바꾸는 타입이라 현장 관중 반응이 큰 선수다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '로렌초 소네고의 가장 큰 강점은 무엇인가요?',
                    answer: '에너지 넘치는 공격 전개와 빠른 템포가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '로렌초 소네고를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    },
    'marcos-giron': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>마르코스 기론는 기본기 완성도가 높아 투어에서 꾸준히 경쟁력을 유지한다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>마르코스 기론의 플레이는 군더더기 없는 스트로크와 안정적인 밸런스를 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>마르코스 기론는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 7.5, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 7.7, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.8, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 8.2, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 8.0, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 8.0, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>화려함보다 정교함을 선호하는 팬층에게 높은 신뢰를 받는 투어형 선수다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '마르코스 기론의 가장 큰 강점은 무엇인가요?',
                    answer: '군더더기 없는 스트로크와 안정적인 밸런스가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '마르코스 기론를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'alejandro-tabilo': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>알레한드로 타빌로는 차분하게 리듬을 바꾸며 상대를 불편하게 만드는 능력이 좋다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>알레한드로 타빌로의 플레이는 왼손 각도와 묵직한 패턴 전개를 앞세운 전개로 정리할 수 있다. 왼손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>알레한드로 타빌로는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 8.0, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 8.2, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.8, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.7, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.7, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 8.1, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>왼손 특유의 각도와 갑작스러운 전개 변화가 잘 보여 전술적인 재미가 큰 편이다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '알레한드로 타빌로의 가장 큰 강점은 무엇인가요?',
                    answer: '왼손 각도와 묵직한 패턴 전개가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '알레한드로 타빌로를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '왼손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    },
    'tomas-martin-etcheverry': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>토마스 마르틴 에체베리는 클레이 기반의 반복형 테니스로 경기 흐름을 길게 끌고 간다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>토마스 마르틴 에체베리의 플레이는 긴 랠리와 높은 볼 견딤 능력을 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>토마스 마르틴 에체베리는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 7.9, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 8.1, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 8.0, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 8.0, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.5, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 8.2, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>한 포인트를 쉽게 포기하지 않는 랠리 집중력 때문에 클레이 팬들에게 선호도가 높다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '토마스 마르틴 에체베리의 가장 큰 강점은 무엇인가요?',
                    answer: '긴 랠리와 높은 볼 견딤 능력이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '토마스 마르틴 에체베리를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'pedro-martinez': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>페드로 마르티네스는 무리하지 않는 운영과 기본기로 승부하는 타입이다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>페드로 마르티네스의 플레이는 정돈된 포인트 설계와 실수 관리를 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>페드로 마르티네스는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 7.1, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 7.7, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.8, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 8.0, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.9, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 8.0, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>전형적인 스페인식 포인트 설계를 좋아하는 팬이라면 안정감 있는 경기 흐름에서 만족도가 높다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '페드로 마르티네스의 가장 큰 강점은 무엇인가요?',
                    answer: '정돈된 포인트 설계와 실수 관리가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '페드로 마르티네스를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'sebastian-ofner': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>제바스티안 오프너는 첫 스트라이크의 질이 높을 때 위력이 크게 살아난다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>제바스티안 오프너의 플레이는 서브 이후 빠른 선공과 직선적인 공격을 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>제바스티안 오프너는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 8.3, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 8.1, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.4, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.5, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.1, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 7.8, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>서브 다음 볼에서 바로 승부를 보는 직선적인 패턴 덕분에 전개가 시원하다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '제바스티안 오프너의 가장 큰 강점은 무엇인가요?',
                    answer: '서브 이후 빠른 선공과 직선적인 공격이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '제바스티안 오프너를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'alexandre-muller': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>알렉상드르 뮐러는 한 포인트씩 쌓아가는 경기 설계가 안정적인 편이다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>알렉상드르 뮐러의 플레이는 차분한 스트로크와 끈질긴 포인트 운영을 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>알렉상드르 뮐러는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 7.4, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 7.6, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.8, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.9, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.8, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 8.1, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>불필요한 기복이 적고 전개가 단단해 경기 전체를 보는 재미가 살아나는 유형이다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '알렉상드르 뮐러의 가장 큰 강점은 무엇인가요?',
                    answer: '차분한 스트로크와 끈질긴 포인트 운영이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '알렉상드르 뮐러를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'francisco-comesana': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>프란시스코 코메사냐는 성장세가 꾸준해 상위 레벨 적응이 기대되는 선수다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>프란시스코 코메사냐의 플레이는 클레이 기반 수비력과 리듬 유지를 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>프란시스코 코메사냐는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 7.0, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 7.7, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.6, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 8.0, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.7, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 7.9, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>랠리의 질이 좋아 성장형 선수 추적을 좋아하는 팬층에 어필하는 스타일이다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '프란시스코 코메사냐의 가장 큰 강점은 무엇인가요?',
                    answer: '클레이 기반 수비력과 리듬 유지가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '프란시스코 코메사냐를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'camilo-ugo-carabelli': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>카밀로 우고 카라벨리는 클레이에서 버티는 힘과 포인트 인내심이 돋보인다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>카밀로 우고 카라벨리의 플레이는 끈질긴 커버와 타이밍 위주의 랠리를 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>카밀로 우고 카라벨리는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 6.9, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 7.6, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.5, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 8.1, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.8, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 8.0, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>클레이 특유의 지구전과 포인트 설계 과정을 즐기는 팬에게 적합한 선수다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '카밀로 우고 카라벨리의 가장 큰 강점은 무엇인가요?',
                    answer: '끈질긴 커버와 타이밍 위주의 랠리가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '카밀로 우고 카라벨리를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'zizou-bergs': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>지주 베르그스는 에너지 레벨이 높고 분위기 반전 능력이 있는 선수다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>지주 베르그스의 플레이는 활발한 발과 적극적인 압박을 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>지주 베르그스는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 7.7, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 7.8, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.5, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 8.4, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.4, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 7.8, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>움직임이 살아 있고 경기 중 에너지 표현이 분명해 현장 반응이 좋은 편이다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '지주 베르그스의 가장 큰 강점은 무엇인가요?',
                    answer: '활발한 발과 적극적인 압박이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '지주 베르그스를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'hamad-medjedovic': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>하마드 메제도비치는 차세대 세르비아 유망주로 자주 언급되는 자원이다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>하마드 메제도비치의 플레이는 파워 중심의 공격과 높은 성장 여지를 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>하마드 메제도비치는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 8.2, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 8.5, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.7, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.6, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.3, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 7.9, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>아직 다듬어질 부분이 남아 있지만 힘과 재능의 폭발력이 분명해 기대치를 모은다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '하마드 메제도비치의 가장 큰 강점은 무엇인가요?',
                    answer: '파워 중심의 공격과 높은 성장 여지가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '하마드 메제도비치를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'jacob-fearnley': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>제이컵 펀리는 개발 속도가 빠르고 전술 이해도가 좋은 편이다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>제이컵 펀리의 플레이는 균형 잡힌 올라운드 전개를 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>제이컵 펀리는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 7.6, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 7.8, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.8, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.9, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.5, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
            ...
            fanAppeal: `<p>과하게 한쪽으로 치우치지 않은 경기 구조 때문에 성장 과정을 지켜보는 맛이 있다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '제이컵 펀리의 가장 큰 강점은 무엇인가요?',
                    answer: '균형 잡힌 올라운드 전개가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '제이컵 펀리를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'billy-harris': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>빌리 해리스는 늦은 성장세로 투어에서 존재감을 넓혀가는 사례다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>빌리 해리스의 플레이는 실전형 운영과 끈질긴 경쟁력을 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>빌리 해리스는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 7.9, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 7.5, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.3, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.6, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.1, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 8.2, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>성장 배경 자체가 스토리성이 있어 응원 포인트가 분명하다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '빌리 해리스의 가장 큰 강점은 무엇인가요?',
                    answer: '실전형 운영과 끈질긴 경쟁력이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '빌리 해리스를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'thiago-seyboth-wild': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>치아구 세이보치 빌드는 리듬을 한 번에 바꿀 수 있는 공격성이 강한 선수다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>치아구 세이보치 빌드의 플레이는 폭발적인 샷 메이킹과 과감한 타이밍을 앞세운 전개로 정리할 수 있다. 오른손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>치아구 세이보치 빌드는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                { name: '서브', score: 8.1, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 8.7, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.4, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.5, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.0, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 7.4, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>잘 맞는 날의 폭발력이 워낙 커서 한 경기만으로도 강한 인상을 남길 수 있다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '치아구 세이보치 빌드의 가장 큰 강점은 무엇인가요?',
                    answer: '폭발적인 샷 메이킹과 과감한 타이밍이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '치아구 세이보치 빌드를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '오른손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'joao-lucas-reis-da-silva': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>주앙 루카스 헤이스 다 시우바는 투어 레벨 적응력을 키워 가는 과정이 중요한 자원이다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>주앙 루카스 헤이스 다 시우바의 플레이는 왼손 각도와 현대적인 베이스라인 패턴을 앞세운 전개로 정리할 수 있다. 왼손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>주앙 루카스 헤이스 다 시우바는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
            ...
            hexagonStats: [
                ...
                { name: '포핸드', score: 7.8, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.4, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.8, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.2, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 7.7, description: '접전 상황에서의 선택과 집중력.' }
            ],
            fanAppeal: `<p>왼손 자원의 희소성과 성장 스토리 덕분에 중장기 추적 가치가 높다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '주앙 루카스 헤이스 다 시우바의 가장 큰 강점은 무엇인가요?',
                    answer: '왼손 각도와 현대적인 베이스라인 패턴이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '주앙 루카스 헤이스 다 시우바를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '왼손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'nishesh-basavareddy': {
        ...
        detailedProfile: {
            ...
            whyNotable: `<p>니셰시 바사바레디는 주니어에서 프로로 이어지는 전환이 매끄러운 유망주다. 폭발적인 하이라이트 한 장면만으로 설명되기보다, 자신의 장점을 반복 가능한 패턴으로 연결해 경기의 흐름을 만들어 간다는 점에서 가치가 크다.</p>`,
            playStyle: `<p>니셰시 바사바레디의 플레이는 정제된 볼 컨트롤과 발전 속도를 앞세운 전개로 정리할 수 있다. 왼손 플레이어답게 코스 선택과 타점 조절이 분명하며, 서브 이후 첫 두세 번의 볼 교환에서 주도권을 잡는 장면이 자주 나온다.</p>`,
            growthStory: `<p>니셰시 바사바레디는 투어 레벨 경험을 쌓으면서 경기 운영의 완성도를 끌어올리는 단계에 있다. 단기적인 이변보다 시즌 전체를 통해 랭킹과 매치 경쟁력을 높여 가는 성장 곡선이 더 중요한 선수다.</p>`,
            signatureMatch: {
                title: '2024 챌린저 상위권전',
                date: '2024',
            ...
            hexagonStats: [
                { name: '서브', score: 7.3, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 7.7, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.8, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.9, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.8, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
            ...
            fanAppeal: `<p>주니어형 재능이 아니라 성인 무대에서도 바로 통할 구조가 보여 기대감이 높다.</p>`,
            recentForm: `<p>최근 흐름에서는 랠리 안정감과 패턴 선택의 일관성이 핵심 지표다. 일정이 누적되는 구간에서 기본기가 유지되면 상위권 선수와의 경기에서도 충분히 변수로 작용할 수 있다.</p>`,
            faq: [
                {
                    question: '니셰시 바사바레디의 가장 큰 강점은 무엇인가요?',
                    answer: '정제된 볼 컨트롤과 발전 속도가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
                    question: '니셰시 바사바레디를 볼 때 체크할 포인트는 무엇인가요?',
                    answer: '왼손 플레이어로서의 코스 선택, 서브 다음 볼의 연결, 그리고 위기 상황에서도 템포를 유지하는지를 보면 이 선수의 경기 수준을 빠르게 파악할 수 있다.'
                }
            ]
        }
    ...
    'clara-tauson': {
        ...
        detailedProfile: {
            ...
            hexagonStats: [
                ...
                { name: '포핸드', score: 8.5, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 8.0, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.3, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.5, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 7.8, description: '접전 상황에서의 선택과 집중력.' }
            ],
            ...
            faq: [
                {
                    ...
                    answer: '강한 볼 스피드와 직선적인 선공이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
            ...
            faq: [
                {
                    ...
                    answer: '왼손 변형 패턴과 다양한 전개가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
            ...
            faq: [
                {
                    ...
                    answer: '콤팩트한 공격과 기본기 안정감이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
            ...
            faq: [
                {
                    ...
                    answer: '운동 능력과 파워가 살아 있는 현대적 공격형이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
    ...
    'peyton-stearns': {
        ...
        detailedProfile: {
            ...
            hexagonStats: [
                { name: '서브', score: 7.4, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 8.0, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.7, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 8.0, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.6, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 8.2, description: '접전 상황에서의 선택과 집중력.' }
            ],
            ...
            faq: [
                {
                    ...
                    answer: '묵직한 랠리와 체력 기반 압박이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
    ...
    'alycia-parks': {
        ...
        detailedProfile: {
            ...
            hexagonStats: [
                { name: '서브', score: 9.0, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 8.0, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.2, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.1, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 6.9, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 7.5, description: '접전 상황에서의 선택과 집중력.' }
            ],
            ...
            faq: [
                {
                    ...
                    answer: '강서브와 빠른 마무리가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
            ...
            faq: [
                {
                    ...
                    answer: '규율 있는 랠리와 흔들림 적은 템포가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
    ...
    'olga-danilovic': {
        ...
        detailedProfile: {
            ...
            hexagonStats: [
                { name: '서브', score: 7.8, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 8.4, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.6, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.5, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.4, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 7.8, description: '접전 상황에서의 선택과 집중력.' }
            ...
            faq: [
                {
                    ...
                    answer: '왼손 파워와 과감한 패턴 전환이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
    ...
    'yulia-putintseva': {
        ...
        detailedProfile: {
            ...
            hexagonStats: [
                ...
                { name: '움직임', score: 8.4, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 8.0, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 8.5, description: '접전 상황에서의 선택과 집중력.' }
            ],
            ...
            faq: [
                {
                    ...
                    answer: '집요한 수비와 까다로운 경기 리듬이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
    ...
    'rebeka-masarova': {
        ...
        detailedProfile: {
            ...
            hexagonStats: [
                { name: '서브', score: 7.8, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 7.9, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.4, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 7.2, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.1, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 7.6, description: '접전 상황에서의 선택과 집중력.' }
            ],
            ...
            faq: [
                {
                    ...
                    answer: '긴 리치와 묵직한 전개가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
    ...
    'elena-avanesyan': {
        ...
        detailedProfile: {
            ...
            hexagonStats: [
                { name: '서브', score: 6.8, description: '첫 서브의 안정감과 무료 포인트 생산력.' },
                { name: '포핸드', score: 7.4, description: '주도권을 잡는 핵심 공격 수단.' },
                { name: '백핸드', score: 7.6, description: '랠리 균형과 방향 전환 완성도.' },
                { name: '움직임', score: 8.2, description: '코트 커버와 타점 진입 속도.' },
                { name: '리턴', score: 7.8, description: '상대 서브를 중립 이상으로 돌려놓는 능력.' },
                { name: '멘탈', score: 8.0, description: '접전 상황에서의 선택과 집중력.' }
            ...
            faq: [
                {
                    ...
                    answer: '끈질긴 랠리와 집중력 있는 수비가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
            ...
            faq: [
                {
                    ...
                    answer: '안정적인 템포와 실수 억제력이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
            ...
            faq: [
                {
                    ...
                    answer: '공격 전환 타이밍과 스트로크 완성도가 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
            ...
            faq: [
                {
                    ...
                    answer: '왼손 패턴과 전방 압박의 조합이 가장 큰 강점이다. 무리한 변칙보다 자신이 잘하는 전개를 반복해 상대를 흔드는 방식에서 강점이 분명하다.'
                },
                {
