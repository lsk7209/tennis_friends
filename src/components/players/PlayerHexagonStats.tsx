...
export default function PlayerHexagonStats({
  attributes,
  playerName,
}: PlayerHexagonStatsProps) {
  ...
  return (
    <div className="my-8">
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400 mb-6">
        ※ 공개된 경기 영상과 기록을 참고해 편집팀이 매긴 주관적 평가이며, 공식
        통계나 협회 랭킹이 아닙니다.
      </p>
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 dark:from-slate-950 dark:to-slate-900 rounded-2xl p-8 shadow-2xl border border-slate-700">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-slate-400">편집팀 종합 평가</p>
            </div>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className={`text-xs font-bold px-2 py-1 rounded-full bg-gradient-to-r ${getScoreColor(attr.score)} text-white`}
                    >
